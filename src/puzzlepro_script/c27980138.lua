...
function c27980138.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(c27980138.filter1, tp, LOCATION_GRAVE, 0, 2, nil) and Duel.IsExistingTarget(c27980138.filter2, tp, LOCATION_ONFIELD, LOCATION_ONFIELD, 1, e:GetHandler())
  end

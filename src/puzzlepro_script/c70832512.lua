...
function c70832512.condition(e, tp, eg, ep, ev, re, r, rp)
  if e:GetHandler():GetFlagEffect(70832512) ~= 0 then
    return false
  end
...
function c70832512.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return e:GetHandler():IsRelateToEffect(e) and e:GetHandler():IsReleasable()
  end
...
function c70832512.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return eg:IsExists(c70832512.dfilter, 1, nil)
  end

...
function c69327790.tdtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  local g1 = nil
  if Duel.IsExistingTarget(nil, tp, LOCATION_ONFIELD, LOCATION_ONFIELD, 1, nil) and Duel.IsExistingTarget(nil, tp, LOCATION_GRAVE, LOCATION_GRAVE, 1, nil) then
  ...
  if e:GetLabel() == 1 and Duel.IsExistingTarget(Card.IsAbleToHand, tp, LOCATION_ONFIELD, LOCATION_ONFIELD, 1, g1) and Duel.SelectYesNo(tp, aux.Stringid(69327790, 2)) then

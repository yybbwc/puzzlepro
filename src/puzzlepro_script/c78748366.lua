...
function c78748366.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c78748366.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c78748366.target(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return a and d and a:IsSetCard(0xbb) and (a:IsAbleToRemove() or d:IsAbleToRemove())
  end

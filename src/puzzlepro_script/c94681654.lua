...
function c94681654.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c94681654.costfilter, tp, LOCATION_MZONE, 0, 1, nil)
  end
...
function c94681654.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c94681654.filter, tp, LOCATION_DECK, 0, 1, nil)
  end

...
function c11167052.filter1(c, e, tp)
  return Duel.IsExistingMatchingCard(c11167052.filter2, tp, LOCATION_DECK, 0, 1, nil, e, tp, c:GetOriginalAttribute()) and Duel.GetMZoneCount(tp, c) > 0
end
...
function c11167052.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return ct > 0 and Duel.IsExistingMatchingCard(c11167052.thfilter, tp, LOCATION_GRAVE, 0, ct, nil)
  end

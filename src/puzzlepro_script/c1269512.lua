...
function c1269512.xyzop(e, tp, chk)
  if chk == 0 then
    return Duel.GetFlagEffect(tp, 1269512) == 0 and Duel.IsExistingMatchingCard(c1269512.cfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c1269512.distg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c1269512.filter, tp, 0, LOCATION_MZONE, 1, nil)
  end

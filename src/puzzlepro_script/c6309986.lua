...
function c6309986.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  e:SetLabel(1)
  if chk == 0 and Duel.GetFieldGroupCount(tp, LOCATION_MZONE, 0) ~= 1 then
    return false
  end
...
function c6309986.target(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    ...
    return res and not Duel.IsPlayerAffectedByEffect(tp, 59822133) and g:CheckSubGroupEach(c6309986.spchecks)
  end

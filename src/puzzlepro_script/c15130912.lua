...
function c15130912.cointg1(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and c15130912.coinfilter1(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c15130912.coinfilter1, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil)
  end

...
function s.ntg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(s.nfilter, tp, 0, LOCATION_MZONE, 1, nil)
  end
end
...
function s.spfilter(c, e, tp)
  return c:IsSetCard(0x18b) and c:IsRace(RACE_MACHINE) and c:IsCanBeSpecialSummoned(e, 0, tp, false, false)
end

...
function c48633301.sprcon(e, c)
  ...
  return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c48633301.sprfilter, tp, LOCATION_MZONE, 0, 1, nil)
end
...
function c48633301.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c48633301.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

...
function c29107423.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c29107423.thfilter, tp, LOCATION_DECK, 0, 1, nil, tp)
  end
...
function c29107423.tetg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c29107423.tefilter, tp, LOCATION_GRAVE + LOCATION_REMOVED, 0, 1, e:GetHandler())
  end

...
function c55538156.condition(e, tp, eg, ep, ev, re, r, rp)
  return re:IsHasType(EFFECT_TYPE_ACTIVATE) and Duel.IsChainNegatable(ev) and Duel.IsExistingMatchingCard(c55538156.cfilter1, tp, LOCATION_MZONE, 0, 1, nil) and Duel.IsExistingMatchingCard(c55538156.cfilter2, tp, LOCATION_ONFIELD, 0, 1, nil)
end

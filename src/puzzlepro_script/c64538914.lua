...
function c64538914.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c64538914.filter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c64538914.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c64538914.costfilter, tp, LOCATION_HAND + LOCATION_GRAVE, 0, 1, nil)
  end

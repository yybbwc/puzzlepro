...
function c26920296.drtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsPlayerCanDraw(tp, 1) and Duel.IsExistingMatchingCard(c26920296.cfilter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil, TYPE_FUSION)
  end
...
function c26920296.lvtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return eg:IsExists(c26920296.lvfilter, 1, nil) and Duel.IsExistingMatchingCard(c26920296.cfilter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil, TYPE_SYNCHRO)
  end

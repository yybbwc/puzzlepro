...
function c83102080.filter(c, ec)
  return c:IsType(TYPE_SPELL + TYPE_TRAP) and c:IsAbleToGraveAsCost() and Duel.IsExistingTarget(c83102080.tgfilter, 0, LOCATION_ONFIELD, LOCATION_ONFIELD, 1, ec, c)
end

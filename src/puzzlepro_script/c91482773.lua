...
function c91482773.spcon(e, c)
  ...
  return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c91482773.spfilter, tp, 0, LOCATION_MZONE, 1, nil)
end
...
function c91482773.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c91482773.filter, tp, LOCATION_HAND, 0, 1, nil, e, tp)
  end

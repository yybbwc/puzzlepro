...
function s.spfilter(c, tp)
  return c:IsFaceup() and c:GetBaseAttack() == 2500 and c:GetBaseDefense() == 2500 and c:IsAbleToRemoveAsCost() and c:IsAbleToRemove(tp, POS_FACEUP, REASON_SPSUMMON) and Duel.GetMZoneCount(tp, c) > 0
end

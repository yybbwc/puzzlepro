...
function c45078193.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c45078193.filter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c45078193.gytg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c45078193.tgfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

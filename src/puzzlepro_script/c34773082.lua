...
function c34773082.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c34773082.filter1, tp, LOCATION_DECK, 0, 1, nil) and Duel.IsExistingMatchingCard(c34773082.filter2, tp, LOCATION_DECK, 0, 1, nil)
  end

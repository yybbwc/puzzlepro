...
function c62849088.spcon(e, tp, eg, ep, ev, re, r, rp)
  ...
  return (ph == PHASE_MAIN1 or ph == PHASE_MAIN2) and Duel.IsExistingMatchingCard(c62849088.cfilter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil)
end
...
function c62849088.destg(e, tp, eg, ep, ev, re, r, rp, chk)
  local b1 = eg:IsExists(c62849088.spfilter, 1, nil, LOCATION_HAND, tp) and Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(Card.IsCanBeSpecialSummoned, tp, LOCATION_HAND, 0, 1, nil, e, 0, tp, false, false)

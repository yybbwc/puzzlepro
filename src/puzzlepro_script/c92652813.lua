...
function c92652813.dmtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c92652813.dmfilter, tp, 0, LOCATION_MZONE, 1, nil)
  end
...
function c92652813.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c92652813.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

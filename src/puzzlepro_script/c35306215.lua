...
function c35306215.otcon(e, c, minc)
  ...
  return minc <= 2 and Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c35306215.rmfilter, tp, LOCATION_GRAVE, 0, 2, nil)
end
...
function c35306215.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c35306215.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

...
function c31076103.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return e:GetHandler():IsAbleToGraveAsCost() and Duel.IsExistingMatchingCard(c31076103.cfilter2, tp, LOCATION_SZONE, 0, 1, nil, 4081094) and Duel.IsExistingMatchingCard(c31076103.cfilter2, tp, LOCATION_SZONE, 0, 1, nil, 78697395)
  end

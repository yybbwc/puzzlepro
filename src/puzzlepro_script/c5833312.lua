...
function c5833312.descon(e, tp, eg, ep, ev, re, r, rp)
  return Duel.IsExistingMatchingCard(c5833312.filter1, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil) and re:IsHasType(EFFECT_TYPE_ACTIVATE) and re:IsActiveType(TYPE_TRAP) and rp == tp
end
...
function c5833312.damcon(e, tp, eg, ep, ev, re, r, rp)
  return Duel.IsExistingMatchingCard(c5833312.filter2, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil) and re:IsHasType(EFFECT_TYPE_ACTIVATE) and re:IsActiveType(TYPE_SPELL) and rp == tp
end
...
function c5833312.atkcon(e, tp, eg, ep, ev, re, r, rp)
  return Duel.IsExistingMatchingCard(c5833312.filter3, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil) and re:IsActiveType(TYPE_MONSTER) and rp == tp
end

...
function s.gcheck(g, tp)
  return Duel.GetMZoneCount(tp, g) > 0 and g:FilterCount(Card.IsType, nil, TYPE_MONSTER) == 1 and g:FilterCount(Card.IsType, nil, TYPE_SPELL) == 1 and g:FilterCount(Card.IsType, nil, TYPE_TRAP) == 1
end
...
function s.rmtg(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return g:CheckSubGroup(s.rmcheck, 3, 3, tp)
  end

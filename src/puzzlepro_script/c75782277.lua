...
function c75782277.check(e, tp, eg, ep, ev, re, r, rp)
  ...
  if g1:GetCount() > 0 then
    Duel.RaiseEvent(g1, EVENT_CUSTOM + 75782277, re, r, rp, 0, 0)
  end
  if g2:GetCount() > 0 then
    Duel.RaiseEvent(g2, EVENT_CUSTOM + 75782277, re, r, rp, 1, 0)
  end
end
...
function c75782277.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsOnField() and c75782277.filter(chkc)
  end
  if chk == 0 then
    return true
  end

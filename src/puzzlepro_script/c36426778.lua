...
function c36426778.spcon(e, c)
  ...
  return Duel.GetLocationCount(c:GetControler(), LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c36426778.filter, c:GetControler(), LOCATION_MZONE, 0, 1, nil)
end
...
function c36426778.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c36426778.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

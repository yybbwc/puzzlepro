...
function c48135190.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(c48135190.filter, tp, 0, LOCATION_ONFIELD, 1, nil) and Duel.IsExistingTarget(c48135190.filter, tp, LOCATION_ONFIELD, 0, 1, e:GetHandler())
  end

...
function c91864689.spfilter(c, e, tp)
  return c:IsSetCard(0x156) and not c:IsCode(91864689) and c:IsCanBeSpecialSummoned(e, 0, tp, false, false, POS_FACEUP_ATTACK)
end
function c91864689.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c91864689.spfilter, tp, LOCATION_HAND, 0, 1, nil, e, tp)
  end

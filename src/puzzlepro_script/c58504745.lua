...
function c58504745.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(c58504745.filter1, tp, LOCATION_GRAVE + LOCATION_ONFIELD, 0, 2, nil) and Duel.IsExistingTarget(c58504745.filter2, tp, 0, LOCATION_GRAVE + LOCATION_ONFIELD, 2, nil)
  end

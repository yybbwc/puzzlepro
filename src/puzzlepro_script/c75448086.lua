...
function c75448086.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c75448086.filter1, tp, LOCATION_HAND, 0, 1, nil) and Duel.IsExistingMatchingCard(c75448086.filter2, tp, LOCATION_DECK, 0, 1, nil)
  end

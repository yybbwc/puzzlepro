...
function c40921744.sumcon(e, c, minc)
  ...
  return c:IsLevelAbove(7) and minc <= 1 and Duel.CheckTribute(c, 1, 1, mg) and ag:GetClassCount(Card.GetCode) >= 4
end
...
function c40921744.descost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c40921744.cfilter, tp, LOCATION_HAND, 0, 1, nil)
  end

...
function c22073844.sptg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and e:GetHandler():IsCanBeSpecialSummoned(e, 0, tp, true, false) and Duel.IsExistingTarget(c22073844.cfilter, tp, LOCATION_GRAVE, LOCATION_GRAVE, 4, nil)
  end

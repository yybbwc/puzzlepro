...
function c97616504.tdtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and c97616504.tdfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c97616504.tdfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

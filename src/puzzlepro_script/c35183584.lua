...
function c35183584.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c35183584.cfilter, tp, LOCATION_HAND + LOCATION_GRAVE, 0, 2, nil)
  end
...
function c35183584.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c35183584.thfilter, tp, LOCATION_GRAVE, 0, 1, nil, e:GetHandler())
  end

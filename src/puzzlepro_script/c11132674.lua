...
function c11132674.xyzop(e, tp, chk)
  if chk == 0 then
    return Duel.GetFlagEffect(tp, 11132674) == 0
  end
...
function c11132674.srtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c11132674.srfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c11132674.desop(e, tp, eg, ep, ev, re, r, rp)
  ...
  if tc:IsAbleToHand() and Duel.SelectOption(tp, aux.Stringid(11132674, 3), aux.Stringid(11132674, 4)) == 1 then

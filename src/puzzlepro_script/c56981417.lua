...
function c56981417.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c56981417.cffilter, tp, LOCATION_HAND, 0, 1, e:GetHandler())
  end
...
function c56981417.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(c56981417.filter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

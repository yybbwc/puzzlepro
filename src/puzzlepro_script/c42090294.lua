...
function c42090294.atkcon(e, tp, eg, ep, ev, re, r, rp)
  return Duel.IsExistingMatchingCard(c42090294.cfilter1, tp, LOCATION_GRAVE, 0, 1, nil) and (Duel.GetCurrentPhase() == PHASE_MAIN1 or Duel.GetCurrentPhase() == PHASE_MAIN2)
end

...
function c92223430.trcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c92223430.costfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c92223430.sumtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c92223430.sumfilter, tp, LOCATION_HAND + LOCATION_MZONE, 0, 1, nil)
  end

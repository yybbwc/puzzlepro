...
function c58012707.dmtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c58012707.tgfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c58012707.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c58012707.spfilter2, tp, LOCATION_GRAVE, 0, 1, nil, e, tp)
  end

...
function c4388680.atkcost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c4388680.atkcfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end
...
function c4388680.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c4388680.thfilter, tp, LOCATION_DECK, 0, 1, nil) and Duel.IsExistingMatchingCard(c4388680.tgfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

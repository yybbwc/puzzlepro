...
function c59019082.condtion(e, tp, eg, ep, ev, re, r, rp)
  ...
  return rp == tp and bit.band(r, REASON_EFFECT) ~= 0 and not rc:IsCode(59019082) and rc:IsSetCard(0x38) and rc:IsType(TYPE_MONSTER) and re:GetActivateLocation() == LOCATION_MZONE and eg:IsExists(c59019082.cfilter, 1, nil)
end

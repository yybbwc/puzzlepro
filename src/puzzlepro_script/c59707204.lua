...
function c59707204.thtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_SZONE) and chkc:IsControler(1 - tp) and c59707204.thfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c59707204.thfilter, tp, 0, LOCATION_SZONE, 1, nil)
  end

...
function c64002884.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c64002884.costfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c64002884.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c64002884.thfilter, tp, 0, LOCATION_SZONE, 1, nil)
  end
...
function c64002884.lvtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c64002884.cffilter, tp, LOCATION_HAND, 0, 1, nil)
  end
end

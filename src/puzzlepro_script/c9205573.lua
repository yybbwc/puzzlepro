...
function c9205573.spcon(e, tp, eg, ep, ev, re, r, rp)
  return (Duel.GetCurrentPhase() == PHASE_MAIN1 or Duel.GetCurrentPhase() == PHASE_MAIN2) and not Duel.IsExistingMatchingCard(c9205573.cfilter, tp, LOCATION_MZONE, 0, 1, nil)
end
...
function c9205573.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c9205573.spfilter, tp, LOCATION_GRAVE, 0, 1, nil, e, tp)
  end

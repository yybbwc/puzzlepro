...
function c36577931.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c36577931.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c36577931.settg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsControler(tp) and chkc:IsLocation(LOCATION_GRAVE) and c36577931.setfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c36577931.setfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

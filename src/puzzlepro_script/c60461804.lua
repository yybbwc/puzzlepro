...
function c60461804.destg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c60461804.desfilter1, tp, LOCATION_ONFIELD, 0, 1, nil)
  end
...
function c60461804.spcon(e, tp, eg, ep, ev, re, r, rp)
  return Duel.GetTurnCount() ~= e:GetLabel() and Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c60461804.spfilter, tp, LOCATION_GRAVE, 0, 1, nil, e, tp)
end

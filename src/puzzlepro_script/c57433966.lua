...
function c57433966.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c57433966.cfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c57433966.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c57433966.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

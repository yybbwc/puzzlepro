...
function c80758812.sptg1(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c80758812.spfilter1, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end
...
function c80758812.sptg2(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.CheckReleaseGroupEx(tp, c80758812.relfilter, 1, REASON_EFFECT, false, nil) and Duel.IsExistingMatchingCard(c80758812.spfilter2, tp, LOCATION_HAND + LOCATION_DECK, 0, 1, nil, e, tp)
  end

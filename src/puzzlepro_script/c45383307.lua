...
function c45383307.lptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return eg:IsExists(c45383307.lpfilter, 1, nil)
  end
end
...
function c45383307.drtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return eg:IsExists(c45383307.drfilter, 1, nil) and Duel.IsPlayerCanDraw(tp, 1)
  end
...
function c45383307.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c45383307.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

...
function c9837195.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(c9837195.filter1, tp, LOCATION_GRAVE, 0, 1, nil) and Duel.IsExistingTarget(c9837195.filter2, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil)
  end

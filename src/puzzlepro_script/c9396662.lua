...
function s.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.CheckReleaseGroup(tp, s.rfilter, 1, c, tp)
  end
...
function s.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsPlayerCanSpecialSummonMonster(tp, 9396663, 0, TYPES_TOKEN_MONSTER, 0, 0, 1, RACE_AQUA, ATTRIBUTE_WATER)
  end

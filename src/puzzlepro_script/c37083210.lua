...
function c37083210.condition(e, tp, eg, ep, ev, re, r, rp)
  ...
  return Duel.GetCurrentPhase() == PHASE_DAMAGE and not Duel.IsDamageCalculated() and a:IsControler(1 - tp) and at and at:IsPosition(POS_FACEUP_DEFENSE) and a:GetAttack() < at:GetDefense()
end

...
function c90506641.condition(e, tp, eg, ep, ev, re, r, rp)
  return Duel.GetFieldGroupCount(tp, 0, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c90506641.cfilter, tp, LOCATION_MZONE, 0, 1, nil)
end
...
function c90506641.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsPlayerCanRemove(tp) and Duel.IsExistingMatchingCard(c90506641.filter, tp, LOCATION_DECK, 0, 5, nil)
  end

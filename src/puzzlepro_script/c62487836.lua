...
function c62487836.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsControler(1 - tp) and chkc:IsLocation(LOCATION_GRAVE) and c62487836.filter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c62487836.filter, tp, 0, LOCATION_GRAVE, 1, nil)
  end

...
function c52404456.shtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c52404456.filter, tp, LOCATION_DECK, 0, 1, nil)
  end
  Duel.SetOperationInfo(0, CATEGORY_TOHAND, nil, 1, tp, LOCATION_DECK)
end
function c52404456.shop(e, tp, eg, ep, ev, re, r, rp)
  if not Duel.IsExistingMatchingCard(c52404456.cfilter, tp, LOCATION_MZONE, 0, 1, e:GetHandler()) then
    return
  end

...
function c41113025.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and c41113025.cfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c41113025.cfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

...
function c39392286.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c39392286.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
  e:SetLabel(0)
  if Duel.IsExistingMatchingCard(c39392286.filter, tp, LOCATION_MZONE, 0, 1, nil) then
    e:SetLabel(1)
  end

...
function c56347375.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c56347375.tdfilter, tp, LOCATION_EXTRA, 0, 1, nil) and Duel.IsExistingMatchingCard(c56347375.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c56347375.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c56347375.spfilter, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end

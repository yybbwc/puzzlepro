...
function c78811937.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c78811937.cfilter, tp, LOCATION_GRAVE, 0, 2, nil)
  end
...
function c78811937.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c78811937.filter, tp, LOCATION_DECK, 0, 1, nil)
  end

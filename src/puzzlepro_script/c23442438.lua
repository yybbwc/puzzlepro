...
function c23442438.sptg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chkc then
    return mg:IsContains(chkc) and c23442438.spfilter(chkc, e, tp)
  end
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and mg:IsExists(c23442438.spfilter, 1, nil, e, tp)
  end

...
function c52038441.distg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and c52038441.disfilter(chkc, g)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c52038441.disfilter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil, g)
  end

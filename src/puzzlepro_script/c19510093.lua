...
function c19510093.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c19510093.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c19510093.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and c:IsCanBeSpecialSummoned(e, 0, tp, false, false) and Duel.IsExistingMatchingCard(c19510093.tgfilter, tp, LOCATION_HAND + LOCATION_DECK, 0, 1, nil)
  end

...
function c17679043.ctrtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsControler(1 - tp) and chkc:IsLocation(LOCATION_MZONE) and c17679043.ctrfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c17679043.ctrfilter, tp, 0, LOCATION_MZONE, 1, nil)
  end

...
function c50947142.condition(e, tp, eg, ep, ev, re, r, rp)
  return Duel.IsExistingMatchingCard(c50947142.filter, tp, LOCATION_MZONE, 0, 1, nil) and re:IsActiveType(TYPE_MONSTER) and Duel.IsChainNegatable(ev) and rp == 1 - tp
end

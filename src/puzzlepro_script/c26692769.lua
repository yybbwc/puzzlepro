...
function c26692769.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c26692769.tgfilter, tp, LOCATION_DECK, 0, 1, nil) and Duel.IsExistingMatchingCard(c26692769.setfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

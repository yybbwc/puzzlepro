...
function c2547033.checkop(e, tp, eg, ep, ev, re, r, rp)
  if not re or not re:GetHandler():IsSetCard(0x103) then
    return
  end
...
function c2547033.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c2547033.tgfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c2547033.discost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c2547033.discfilter, tp, LOCATION_HAND, 0, 1, nil)
  end

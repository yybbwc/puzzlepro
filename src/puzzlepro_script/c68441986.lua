...
function c68441986.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c68441986.spfilter, tp, LOCATION_HAND, 0, 1, nil, e, tp)
  end
...
function c68441986.countertg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return ct > 0 and Duel.IsExistingTarget(c68441986.tgfilter, tp, 0, LOCATION_MZONE, 1, nil)
  end

...
function s.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.GetMZoneCount(tp, g, tp) > 0 and c:IsCanBeSpecialSummoned(e, 0, tp, false, false) and g:GetCount() > 0
  end
...
function s.spop(e, tp, eg, ep, ev, re, r, rp)
  ...
  if g:GetCount() > 0 and Duel.SendtoGrave(g, REASON_EFFECT) > 0 and g:IsExists(Card.IsLocation, 1, nil, LOCATION_GRAVE) and c:IsRelateToEffect(e) and aux.NecroValleyFilter()(c) then

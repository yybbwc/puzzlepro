...
function c79531196.tgtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c79531196.filter, tp, LOCATION_DECK + LOCATION_HAND, 0, 1, nil)
  end
...
function c79531196.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c79531196.cfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

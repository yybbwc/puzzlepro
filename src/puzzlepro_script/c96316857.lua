...
function c96316857.rctg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsControler(tp) and chkc:IsLocation(LOCATION_GRAVE) and c96316857.filter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c96316857.filter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

...
function c38412161.remtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(1 - tp) and c38412161.remfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c38412161.remfilter, tp, 0, LOCATION_GRAVE, 1, nil)
  end

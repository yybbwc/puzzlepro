...
function c1855886.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c1855886.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c1855886.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c1855886.cfilter, tp, LOCATION_GRAVE, 0, 1, e:GetHandler())
  end

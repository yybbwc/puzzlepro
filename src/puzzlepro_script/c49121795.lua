...
function c49121795.datg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(tp) and c49121795.dafilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c49121795.dafilter, tp, LOCATION_MZONE, 0, 1, nil)
  end
...
function c49121795.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c49121795.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

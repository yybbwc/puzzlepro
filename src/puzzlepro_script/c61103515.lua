...
function c61103515.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c61103515.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c61103515.sumtg(e, tp, eg, ep, ev, re, r, rp, chk)
  local c = e:GetHandler()
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c61103515.thcheck, tp, LOCATION_DECK, 0, 1, nil)
  end
end

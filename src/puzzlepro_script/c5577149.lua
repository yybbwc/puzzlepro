...
function c5577149.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c5577149.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c5577149.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c5577149.spfilter, tp, LOCATION_HAND, 0, 1, nil, e, tp)
  end

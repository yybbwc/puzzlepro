...
function c88240808.rmtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsControler(1 - tp) and chkc:IsLocation(LOCATION_GRAVE) and c88240808.filter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c88240808.filter, tp, 0, LOCATION_GRAVE, 1, nil)
  end

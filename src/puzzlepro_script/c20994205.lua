...
function c20994205.condition(e, tp, eg, ep, ev, re, r, rp)
  return not Duel.IsExistingMatchingCard(c20994205.cfilter, tp, LOCATION_MZONE, 0, 1, nil) and Duel.IsExistingMatchingCard(c20994205.cfilter, tp, 0, LOCATION_MZONE, 1, nil)
end
...
function c20994205.spfilter(c, e, tp)
  return c20994205.nofilter(c) and c:IsCanBeSpecialSummoned(e, SUMMON_TYPE_XYZ, tp, false, false) and Duel.GetLocationCountFromEx(tp, tp, nil, c) > 0
end

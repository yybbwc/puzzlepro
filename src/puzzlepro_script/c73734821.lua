...
function c73734821.thtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_SZONE) and chkc:IsControler(tp) and c73734821.thfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c73734821.thfilter, tp, LOCATION_SZONE, 0, 1, nil)
  end

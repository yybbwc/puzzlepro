...
function s.hspchk(g, tp, sc)
  return Duel.GetLocationCountFromEx(tp, tp, g, sc) > 0 and g:GetClassCount(Card.GetRace) == #g
end
...
function s.chtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(aux.TRUE, rp, 0, LOCATION_ONFIELD, 1, nil)
  end
end

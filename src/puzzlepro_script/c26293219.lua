...
function c26293219.rtgtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_REMOVED) and c26293219.filter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c26293219.filter, tp, LOCATION_REMOVED, LOCATION_REMOVED, 1, nil)
  end

...
function c63261835.thtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and c63261835.thfilter(chkc, tp)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c63261835.thfilter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil, tp)
  end

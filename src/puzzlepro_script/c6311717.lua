...
function c6311717.sptg2(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(c6311717.tgfilter2, tp, LOCATION_MZONE, 0, 1, nil, tp) and Duel.IsExistingMatchingCard(c6311717.spfilter2, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end

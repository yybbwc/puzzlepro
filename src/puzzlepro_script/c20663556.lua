...
function c20663556.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return ft > -1 and Duel.CheckReleaseGroup(tp, c20663556.cfilter, 1, nil, ft, tp)
  end
...
function c20663556.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c20663556.filter, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end

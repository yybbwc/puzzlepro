...
function c12148078.cfilter(c, e, tp)
  return c:IsDiscardable() and Duel.IsExistingMatchingCard(c12148078.spfilter, tp, LOCATION_DECK + LOCATION_HAND, 0, 1, c, e, tp, 6)
end
...
function c12148078.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  e:SetLabel(100)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c12148078.cfilter, tp, LOCATION_HAND, 0, 1, e:GetHandler(), e, tp)
  end

...
function c53936268.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c53936268.cfilter, tp, LOCATION_HAND + LOCATION_ONFIELD, 0, 1, e:GetHandler())
  end
...
function c53936268.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c53936268.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

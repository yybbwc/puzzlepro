...
function c24027078.condition(e, tp, eg, ep, ev, re, r, rp)
  return ep ~= tp and Duel.IsChainNegatable(ev) and Duel.IsExistingMatchingCard(c24027078.filter1, tp, LOCATION_MZONE, 0, 1, nil) and Duel.IsExistingMatchingCard(c24027078.filter2, tp, LOCATION_ONFIELD, 0, 1, nil)
end

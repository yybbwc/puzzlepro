...
function c79418928.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c79418928.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c79418928.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > -1 and Duel.IsExistingMatchingCard(c79418928.spfilter, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end

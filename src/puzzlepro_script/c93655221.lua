...
function c93655221.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return e:IsCostChecked() and Duel.IsExistingTarget(c93655221.eqfilter, tp, LOCATION_MZONE, 0, 1, nil) and Duel.IsExistingTarget(c93655221.disfilter, tp, 0, LOCATION_MZONE, 1, nil)
  end

...
function c30802207.destg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsOnField() and c30802207.desfilter(chkc) and chkc:IsControler(1 - tp)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c30802207.desfilter, tp, 0, LOCATION_ONFIELD, 1, nil)
  end

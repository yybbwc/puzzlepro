...
function c85243784.tktg(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return mg:IsExists(Card.IsType, 1, nil, TYPE_LINK) and Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsPlayerCanSpecialSummonMonster(tp, 48068379, 0, TYPES_TOKEN_MONSTER, 0, 0, 1, RACE_CYBERSE, ATTRIBUTE_LIGHT)
  end

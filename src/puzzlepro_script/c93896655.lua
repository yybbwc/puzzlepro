...
function c93896655.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c93896655.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c93896655.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c93896655.spfilter, tp, LOCATION_EXTRA, 0, 1, nil, e, tp)
  end

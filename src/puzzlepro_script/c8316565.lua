...
function c8316565.condition(e, tp, eg, ep, ev, re, r, rp)
  ...
  return Duel.IsExistingMatchingCard(c8316565.cfilter, tp, LOCATION_MZONE, 0, 1, nil) and ph > PHASE_MAIN1 and ph < PHASE_MAIN2 and (re:IsActiveType(TYPE_MONSTER) or re:IsHasType(EFFECT_TYPE_ACTIVATE)) and Duel.IsChainNegatable(ev)
end

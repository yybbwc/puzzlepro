...
function c44656450.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c44656450.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c44656450.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetMZoneCount(tp, e:GetHandler()) > 0 and Duel.IsExistingMatchingCard(c44656450.spfilter, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end

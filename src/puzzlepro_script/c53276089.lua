...
function s.activate(e, tp, eg, ep, ev, re, r, rp)
  ...
  if c:IsRelateToEffect(e) and Duel.IsExistingMatchingCard(s.ovfilter, tp, LOCATION_MZONE, 0, 1, nil, e) and c:IsCanOverlay() and c:IsOnField() and Duel.SelectYesNo(tp, aux.Stringid(id, 2)) then
    Duel.BreakEffect()

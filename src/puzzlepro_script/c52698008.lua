...
function c52698008.thcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c52698008.cfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end
...
function c52698008.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c52698008.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

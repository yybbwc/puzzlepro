...
function c79371769.thtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chkc then
    return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and c79371769.thfilter(chkc, tid)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c79371769.thfilter, tp, LOCATION_GRAVE, 0, 1, nil, tid)
  end

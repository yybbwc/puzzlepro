...
function c63101468.copycost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c63101468.copyfilter, tp, LOCATION_HAND + LOCATION_DECK + LOCATION_EXTRA, 0, 1, nil) and c:GetFlagEffect(63101468) == 0
  end
...
function c63101468.rmcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c63101468.cfilter, tp, LOCATION_HAND + LOCATION_GRAVE, 0, 1, nil)
  end

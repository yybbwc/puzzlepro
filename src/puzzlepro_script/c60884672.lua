...
function c60884672.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c60884672.costfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c60884672.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c60884672.spfilter, tp, LOCATION_EXTRA, 0, 1, nil, e, tp)
  end

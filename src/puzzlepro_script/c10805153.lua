...
function c10805153.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc, exc)
  ...
  if chk == 0 then
    return aux.bpcon(e, tp, eg, ep, ev, re, r, rp) and Duel.IsExistingTarget(c10805153.filter, tp, LOCATION_MZONE, 0, 1, exc)
  end
...
function c10805153.thcon(e, tp, eg, ep, ev, re, r, rp)
  return Duel.GetTurnPlayer() == tp and Duel.IsExistingMatchingCard(c10805153.rccfilter, tp, LOCATION_MZONE, 0, 1, nil)
end

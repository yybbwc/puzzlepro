...
function c2204140.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingTarget(c2204140.rmfilter, tp, 0, LOCATION_GRAVE, 1, nil) and Duel.IsExistingTarget(c2204140.spfilter, tp, LOCATION_GRAVE, 0, 1, nil, e, tp)
  end

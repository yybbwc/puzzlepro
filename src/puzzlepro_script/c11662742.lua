...
function c11662742.descon3(e, tp, eg, ep, ev, re, r, rp)
  return bit.band(r, REASON_EFFECT) ~= 0 and e:GetHandler():GetControler() == ep and (Duel.GetCurrentPhase() ~= PHASE_DAMAGE or Duel.IsDamageCalculated())
end

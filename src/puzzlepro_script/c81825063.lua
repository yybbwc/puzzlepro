...
function c81825063.spcon(e, tp, eg, ep, ev, re, r, rp)
  return Duel.GetFieldGroupCount(tp, 0, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c81825063.cfilter, tp, LOCATION_MZONE, 0, 1, nil)
end
...
function c81825063.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c81825063.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

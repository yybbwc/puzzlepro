...
function c4290468.atkcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c4290468.costfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end
...
function c4290468.dacon(e, tp, eg, ep, ev, re, r, rp)
  return Duel.GetCurrentPhase() == PHASE_BATTLE_STEP and e:GetHandler():GetAttackedCount() ~= 0 and Duel.GetAttacker() == nil and Duel.GetCurrentChain() == 0
end

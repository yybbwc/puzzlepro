...
function c31434645.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c31434645.filter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c31434645.tgtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c31434645.tgfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

...
function c21200905.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.CheckReleaseGroup(tp, c21200905.cfilter, 1, nil, lg)
  end
...
function c21200905.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > -1 and Duel.IsExistingMatchingCard(c21200905.spfilter, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end

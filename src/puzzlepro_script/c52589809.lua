...
function c52589809.spcon(e, c)
  ...
  return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c52589809.filter, tp, LOCATION_MZONE, 0, 1, nil)
end
...
function c52589809.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c52589809.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

...
function c81613061.actcon(e)
  ...
  return Duel.GetCurrentPhase() == PHASE_MAIN1 and Duel.IsExistingMatchingCard(Card.IsSummonType, tp, 0, LOCATION_MZONE, 1, nil, SUMMON_TYPE_SPECIAL) and Duel.IsExistingMatchingCard(c81613061.actfilter, tp, LOCATION_MZONE, 0, 1, nil)
end
...
function c81613061.settg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c81613061.setfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
end

...
function c9354555.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c9354555.filter1, tp, LOCATION_HAND, 0, 3, nil) and Duel.IsExistingMatchingCard(c9354555.filter2, tp, LOCATION_DECK, 0, 1, nil)
  end

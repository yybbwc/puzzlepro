...
function c70485614.reptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return eg:IsExists(c70485614.dfilter, 1, nil, tp) and Duel.IsExistingMatchingCard(c70485614.repfilter, tp, LOCATION_EXTRA, 0, 1, nil)
  end
...
function c70485614.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c70485614.spfilter, tp, LOCATION_HAND + LOCATION_DECK, 0, 1, nil, e, tp)
  end

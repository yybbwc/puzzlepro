...
function c61011438.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c61011438.cfilter, tp, LOCATION_HAND, 0, 1, e:GetHandler())
  end
...
function c61011438.cpcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c61011438.cpfilter, tp, LOCATION_EXTRA, 0, 1, nil)
  end

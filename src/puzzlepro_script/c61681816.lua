...
function c61681816.rctg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c61681816.cfilter, tp, LOCATION_MZONE, 0, 1, nil)
  end
...
function c61681816.tgoval(e, re, rp)
  return rp == 1 - e:GetHandlerPlayer() and re:GetActivateLocation() == LOCATION_MZONE and re:GetHandler():IsRace(e:GetHandler():GetRace())
end

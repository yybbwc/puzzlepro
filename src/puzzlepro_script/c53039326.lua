...
function c53039326.check(e, tp, eg, ep, ev, re, r, rp)
  ...
  if g1:GetCount() > 0 then
    Duel.RaiseEvent(g1, EVENT_CUSTOM + 53039326, re, r, rp, turnp, 0)
  end
  if g2:GetCount() > 0 then
    Duel.RaiseEvent(g2, EVENT_CUSTOM + 53039326, re, r, rp, 1 - turnp, 0)
  end
end
...
function c53039326.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c53039326.filter, tp, LOCATION_DECK, 0, 1, nil)
  end

...
function c86607583.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return e:IsCostChecked() and Duel.IsCanAddCounter(tp, 0x47, 1, e:GetHandler()) and Duel.IsExistingMatchingCard(c86607583.spfilter, tp, LOCATION_EXTRA, 0, 1, nil, e, tp) and Duel.IsExistingMatchingCard(c86607583.cfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

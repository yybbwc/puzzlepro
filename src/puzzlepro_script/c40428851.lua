...
function c40428851.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c40428851.costfilter, tp, LOCATION_HAND + LOCATION_ONFIELD, 0, 1, nil, tp)
  end
...
function c40428851.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c40428851.spfilter, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end

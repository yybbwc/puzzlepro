...
function c88753594.atktg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(tp) and c88753594.atkfilter2(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c88753594.atkfilter2, tp, LOCATION_MZONE, 0, 1, nil)
  end

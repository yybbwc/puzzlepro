...
function c18967507.eqtg(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_SZONE) > 0 and Duel.IsExistingMatchingCard(c18967507.eqfilter, tp, LOCATION_GRAVE, loc, 1, nil, tp)
  end
...
function c18967507.negcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c18967507.negfilter, tp, LOCATION_ONFIELD, 0, 1, nil)
  end

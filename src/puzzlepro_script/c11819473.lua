...
function c11819473.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c11819473.thfilter1, tp, LOCATION_DECK, 0, 1, nil) or Duel.IsExistingMatchingCard(c11819473.thfilter2, tp, 0, LOCATION_DECK, 1, nil, 1 - tp)
  end
...
function c11819473.sumtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c11819473.sumfilter, tp, LOCATION_HAND, 0, 1, nil)
  end

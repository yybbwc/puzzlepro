...
function c7565547.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(Card.IsFaceup, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil) and Duel.IsExistingMatchingCard(c7565547.eqfilter, tp, LOCATION_SZONE, LOCATION_SZONE, 1, nil)
  end

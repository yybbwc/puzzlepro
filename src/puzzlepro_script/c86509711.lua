...
function c86509711.cfilter(c, e, tp)
  return c:IsCode(46986414, 38033121) and c:IsReleasable() and Duel.GetMZoneCount(tp, c) > 0 and Duel.IsExistingMatchingCard(c86509711.spfilter, tp, LOCATION_HAND + LOCATION_GRAVE, 0, 1, nil, e, tp, c:GetCode())
end

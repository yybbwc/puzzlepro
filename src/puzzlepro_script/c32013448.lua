...
function c32013448.mtcon(e, tp, eg, ep, ev, re, r, rp)
  return r == REASON_RITUAL and eg:IsExists(Card.IsSetCard, 1, nil, 0x10cf) and not e:GetHandler():IsPreviousLocation(LOCATION_OVERLAY)
end
...
function c32013448.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c32013448.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

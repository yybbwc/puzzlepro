...
function c63053267.thcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return e:GetHandler():IsAbleToRemoveAsCost() and Duel.IsExistingMatchingCard(c63053267.cfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c63053267.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c63053267.filter, tp, LOCATION_DECK, 0, 1, nil)
  end

...
function c8512558.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c8512558.spfilter, tp, LOCATION_HAND, 0, 1, nil, e, tp)
  end
...
function c8512558.gcheck(g)
  if #g == 1 then
    return true
  elseif #g == 2 then
    return g:CheckSubGroupEach(c8512558.combination2[1]) or g:CheckSubGroupEach(c8512558.combination2[2]) or g:CheckSubGroupEach(c8512558.combination2[3]) or g:CheckSubGroupEach(c8512558.combination2[4]) or g:CheckSubGroupEach(c8512558.combination2[5]) or g:CheckSubGroupEach(c8512558.combination2[6])
  elseif #g == 3 then
    return g:CheckSubGroupEach(c8512558.combination3[1]) or g:CheckSubGroupEach(c8512558.combination3[2]) or g:CheckSubGroupEach(c8512558.combination3[3]) or g:CheckSubGroupEach(c8512558.combination3[4])
  elseif #g == 4 then

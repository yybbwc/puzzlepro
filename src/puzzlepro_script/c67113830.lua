...
function c67113830.condition(e, tp, eg, ep, ev, re, r, rp)
  return aux.dscon(e, tp, eg, ep, ev, re, r, rp) and Duel.GetFieldGroupCount(tp, 0, LOCATION_GRAVE) > 7
end
...
function c67113830.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c67113830.filter, tp, 0, LOCATION_MZONE, 1, nil)
  end
end

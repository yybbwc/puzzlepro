...
function c51701885.rmtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c51701885.filter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c51701885.spcon(e, tp, eg, ep, ev, re, r, rp)
  ...
  local c = e:GetHandler()
  return tc and Duel.GetTurnCount() ~= tc:GetTurnID() and Duel.GetTurnPlayer() == tp and c:GetFlagEffect(51701885) ~= 0 and tc:GetFlagEffect(51701885) ~= 0
end

...
function c59353647.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(c59353647.desfilter, tp, LOCATION_ONFIELD, 0, 1, nil, tp) and Duel.IsExistingTarget(c59353647.spfilter, tp, LOCATION_GRAVE, 0, 1, nil, e, tp)
  end

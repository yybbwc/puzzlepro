...
function c86066372.atktg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chkc then
    return mg:IsContains(chkc) and c86066372.atkfilter(chkc, e)
  end
  if chk == 0 then
    return mg:IsExists(c86066372.atkfilter, 1, nil, e)
  end
...
function c86066372.descost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c86066372.cfilter, tp, LOCATION_MZONE + LOCATION_GRAVE, 0, 1, nil)
  end

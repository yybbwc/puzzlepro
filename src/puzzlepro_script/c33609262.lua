...
function c33609262.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c33609262.cfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c33609262.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c33609262.filter, tp, LOCATION_DECK, 0, 1, nil)
  end

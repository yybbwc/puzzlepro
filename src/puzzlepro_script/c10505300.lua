...
function c10505300.spfilter1(c)
  return c:IsFaceup() and c:IsLevelAbove(0) and Duel.IsExistingMatchingCard(c10505300.spfilter2, 0, LOCATION_MZONE, LOCATION_MZONE, 1, c, c:GetLevel())
end
...
function c10505300.spcon(e, c)
  ...
  return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c10505300.spfilter1, 0, LOCATION_MZONE, LOCATION_MZONE, 1, nil)
end

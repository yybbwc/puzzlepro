...
function c56894757.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc, exc)
  ...
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c56894757.cfilter, tp, LOCATION_MZONE, 0, 1, exc) and Duel.IsExistingTarget(Card.IsAbleToHand, tp, 0, LOCATION_SZONE, 1, nil)
  end
...
function c56894757.thcon(e, tp, eg, ep, ev, re, r, rp)
  return Duel.GetTurnPlayer() == tp and Duel.IsExistingMatchingCard(c56894757.rccfilter, tp, LOCATION_MZONE, 0, 1, nil)
end

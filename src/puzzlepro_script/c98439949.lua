...
function c98439949.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.CheckReleaseGroup(tp, c98439949.cfilter, 1, nil, tp)
  end
...
function c98439949.thcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c98439949.thcfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end
...
function c98439949.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c98439949.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

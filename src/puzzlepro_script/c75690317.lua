...
function c75690317.postg1(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(tp) and c75690317.posfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c75690317.posfilter, tp, LOCATION_MZONE, 0, 1, nil)
  end

...
function c90960358.spcon(e, c)
  ...
  return Duel.IsExistingMatchingCard(c90960358.cfilter, tp, LOCATION_ONFIELD, 0, 1, nil) and Duel.CheckReleaseGroupEx(tp, c90960358.spcfilter, 1, REASON_SPSUMMON, false, nil, tp)
end

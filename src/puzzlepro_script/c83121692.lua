...
function c83121692.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(tp) and c83121692.tgfilter(chkc, c)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c83121692.tgfilter, tp, LOCATION_MZONE, 0, 1, nil, c)
  end

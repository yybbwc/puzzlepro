...
function c31834488.postg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and c31834488.posfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c31834488.posfilter, tp, LOCATION_MZONE, LOCATION_MZONE, 2, nil)
  end

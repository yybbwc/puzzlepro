...
function c86239173.tg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c86239173.pfilter, tp, LOCATION_DECK + LOCATION_GRAVE, 0, 1, nil, tp)
  end
end
...
function c86239173.sumtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c86239173.sumfilter, tp, LOCATION_HAND + LOCATION_MZONE, 0, 1, nil)
  end

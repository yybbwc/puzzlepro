...
function c12369277.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c12369277.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c12369277.tdtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and c12369277.tdfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c12369277.tdfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

...
function c73478096.spcon(e, tp, eg, ep, ev, re, r, rp)
  ...
  return not c:IsPreviousLocation(LOCATION_ONFIELD) and Duel.IsExistingMatchingCard(c73478096.cfilter, tp, LOCATION_MZONE + LOCATION_GRAVE, 0, 1, c)
end
...
function c73478096.sumop(e, tp, eg, ep, ev, re, r, rp)
  if Duel.GetFlagEffect(tp, 73478096) ~= 0 then
    return
  end

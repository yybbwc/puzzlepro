...
function c54334420.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c54334420.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c54334420.thop(e, tp, eg, ep, ev, re, r, rp)
  ...
  if g:GetCount() > 0 then
    ...
    if Duel.IsExistingMatchingCard(c54334420.sumfilter, tp, LOCATION_HAND + LOCATION_MZONE, 0, 1, nil) and Duel.SelectYesNo(tp, aux.Stringid(54334420, 2)) then
      Duel.BreakEffect()
      Duel.ShuffleHand(tp)

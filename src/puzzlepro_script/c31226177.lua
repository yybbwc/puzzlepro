...
function c31226177.destg(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return bc and c:GetLinkedGroup():IsContains(bc)
  end
...
function c31226177.sptg2(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c31226177.spfilter2, tp, LOCATION_HAND, 0, 1, nil, e, tp)
  end

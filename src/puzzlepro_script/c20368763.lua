...
function c20368763.spcost2(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return ft > -1 and Duel.CheckReleaseGroup(tp, c20368763.spcfilter, 1, nil, ft, tp)
  end
...
function c20368763.sptg2(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c20368763.spfilter, tp, LOCATION_HAND, 0, 1, nil, e, tp)
  end

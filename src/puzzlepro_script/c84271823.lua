...
function c84271823.tgfilter1(c, e, tp)
  return c:IsFaceup() and c:IsLevelAbove(0) and Duel.IsExistingMatchingCard(c84271823.tgfilter2, tp, 0, LOCATION_MZONE, 1, nil, e, c:GetLevel())
end
...
function c84271823.destg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(c84271823.tgfilter1, tp, LOCATION_MZONE, 0, 1, nil, e, tp)
  end

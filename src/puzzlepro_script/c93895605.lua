...
function c93895605.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return a:IsOnField() and a:IsCanBeEffectTarget(e) and d:IsOnField() and d:IsCanBeEffectTarget(e)
  end
...
function c93895605.activate(e, tp, eg, ep, ev, re, r, rp)
  ...
  if a:IsRelateToEffect(e) and a:IsAttackable() and not a:IsStatus(STATUS_ATTACK_CANCELED) and d:IsFaceup() and d:IsRelateToEffect(e) then

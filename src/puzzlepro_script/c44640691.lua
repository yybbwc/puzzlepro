...
function c44640691.setcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return e:GetHandler():IsCanRemoveCounter(tp, 0x1, 1, REASON_COST) and Duel.IsExistingMatchingCard(c44640691.costfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c44640691.settg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c44640691.filter, tp, LOCATION_DECK, 0, 1, nil)
  end
end

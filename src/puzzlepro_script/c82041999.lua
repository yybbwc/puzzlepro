...
function c82041999.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c82041999.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c82041999.atkcon(e, tp, eg, ep, ev, re, r, rp)
  return rp == tp and re:GetHandler():IsSetCard(0x171) and (re:IsActiveType(TYPE_MONSTER) or re:IsHasType(EFFECT_TYPE_ACTIVATE)) and eg:IsExists(c82041999.cfilter, 1, nil, tp)
end

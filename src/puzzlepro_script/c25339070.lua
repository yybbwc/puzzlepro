...
function c25339070.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c25339070.cfilter, tp, LOCATION_HAND, 0, 2, e:GetHandler())
  end
...
function c25339070.cptg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(c25339070.cpfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

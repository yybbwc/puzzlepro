...
function c97112505.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetMZoneCount(tp, e:GetHandler()) > 0 and Duel.IsExistingMatchingCard(c97112505.spfilter, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end
...
function c97112505.thcost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c97112505.thcfilter, tp, LOCATION_GRAVE, 0, 1, c)
  end

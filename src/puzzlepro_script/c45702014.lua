...
function c45702014.setcost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c45702014.costfilter, tp, loc, 0, 1, nil)
  end
...
function c45702014.settg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and c45702014.setfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c45702014.setfilter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil)
  end

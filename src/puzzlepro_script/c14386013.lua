...
function c14386013.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c14386013.thfilter, tp, LOCATION_DECK + LOCATION_GRAVE, 0, 1, nil)
  end
...
function c14386013.drtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsPlayerCanDraw(tp) and Duel.IsExistingMatchingCard(c14386013.drfilter, tp, LOCATION_HAND + LOCATION_GRAVE, 0, 1, nil)
  end

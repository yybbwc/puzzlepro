...
function c42314669.condition(e, tp, eg, ep, ev, re, r, rp)
  return Duel.GetCurrentPhase() == PHASE_MAIN1 and not Duel.CheckPhaseActivity() and not Duel.IsExistingMatchingCard(c42314669.cfilter, tp, LOCATION_MZONE, 0, 1, nil)
end

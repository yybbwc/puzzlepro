...
function c64116319.dircon(e)
  ...
  return Duel.IsExistingMatchingCard(c64116319.cfilter1, tp, LOCATION_ONFIELD, 0, 1, nil) and not Duel.IsExistingMatchingCard(c64116319.cfilter2, tp, 0, LOCATION_MZONE, 1, nil)
end
...
function c64116319.spop1(e, tp, eg, ep, ev, re, r, rp)
  ...
  if c:IsRelateToEffect(e) and Duel.SpecialSummon(c, 0, tp, tp, false, false, POS_FACEUP) ~= 0 then
    ...
    if #g > 0 and Duel.IsExistingMatchingCard(c64116319.cfilter2, tp, LOCATION_ONFIELD, 0, 1, c) and Duel.SelectYesNo(tp, aux.Stringid(64116319, 1)) then
      Duel.BreakEffect()

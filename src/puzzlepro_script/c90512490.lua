...
function c90512490.thtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and c90512490.thfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c90512490.thfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

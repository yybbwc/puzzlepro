...
function c23303072.spcon(e, c)
  ...
  return Duel.GetLocationCount(c:GetControler(), LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c23303072.filter, c:GetControler(), LOCATION_HAND, 0, 3, e:GetHandler())
end

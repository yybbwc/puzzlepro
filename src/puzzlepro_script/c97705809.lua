...
function c97705809.condition(e, tp, eg, ep, ev, re, r, rp)
  return Duel.GetTurnPlayer() ~= tp and Duel.GetFieldGroupCount(tp, LOCATION_MZONE, 0) ~= 0 and not Duel.IsExistingMatchingCard(c97705809.cfilter, tp, LOCATION_MZONE, 0, 1, nil)
end

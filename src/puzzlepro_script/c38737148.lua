...
function c38737148.spcon(e, c)
  ...
  return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(Card.IsAttribute, tp, LOCATION_GRAVE, 0, 4, nil, ATTRIBUTE_LIGHT)
end
...
function c38737148.destg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(c38737148.desfilter, tp, LOCATION_FZONE, LOCATION_FZONE, 1, nil)
  end

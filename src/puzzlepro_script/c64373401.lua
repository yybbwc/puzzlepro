...
function c64373401.hspcon(e, c)
  ...
  return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and not Duel.IsExistingMatchingCard(c64373401.filter, tp, LOCATION_GRAVE, 0, 1, nil)
end
...
function c64373401.spcon(e, tp, eg, ep, ev, re, r, rp)
  ...
  return c:IsLocation(LOCATION_GRAVE) and r == REASON_SUMMON and c:GetReasonCard():IsSetCard(0x9a) and not Duel.IsExistingMatchingCard(c64373401.filter, tp, LOCATION_GRAVE, 0, 1, nil)
end

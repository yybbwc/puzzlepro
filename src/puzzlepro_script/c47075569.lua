...
function c47075569.thtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(aux.TRUE, tp, LOCATION_ONFIELD, 0, 1, nil) and Duel.IsExistingMatchingCard(c47075569.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c47075569.thop(e, tp, eg, ep, ev, re, r, rp)
  ...
  if ct > g:GetClassCount(Card.GetCode) then
    return
  end

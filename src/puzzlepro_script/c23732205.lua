...
function c23732205.destg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(1 - tp) and c23732205.desfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c23732205.desfilter, tp, 0, LOCATION_MZONE, 1, nil)
  end

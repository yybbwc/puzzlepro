...
function c70226289.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc, exc)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c70226289.filter, tp, LOCATION_HAND, 0, 1, exc, e, tp)
  end
...
function c70226289.thcon(e, tp, eg, ep, ev, re, r, rp)
  return Duel.GetTurnPlayer() == tp and Duel.IsExistingMatchingCard(c70226289.rccfilter, tp, LOCATION_MZONE, 0, 1, nil)
end

...
function c90207654.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c90207654.rmfilter, tp, LOCATION_HAND + LOCATION_ONFIELD, 0, 1, nil, tp) and Duel.IsExistingMatchingCard(c90207654.spfilter, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end

...
function c22200403.destg(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return tc and tc:IsFaceup() and tc:IsSummonType(SUMMON_TYPE_PENDULUM)
  end
...
function c22200403.drcon1(e, tp, eg, ep, ev, re, r, rp)
  return c22200403.effcon(e) and e:GetHandler():IsRelateToBattle()
end
...
function c22200403.drcon2(e, tp, eg, ep, ev, re, r, rp)
  return c22200403.effcon(e) and bit.band(r, REASON_EFFECT) ~= 0 and re:GetHandler() == e:GetHandler()
end

...
function c89882100.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_SZONE) and chkc:IsControler(1 - tp) and c89882100.filter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c89882100.filter, tp, 0, LOCATION_SZONE, 1, nil)
  end

...
function c11302671.spop2(e, tp, eg, ep, ev, re, r, rp)
  ...
  local ct = g:GetCount()
  if ct > 0 and Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and g:FilterCount(c11302671.spfilter, nil, e, tp) > 0 and Duel.SelectYesNo(tp, aux.Stringid(11302671, 2)) then

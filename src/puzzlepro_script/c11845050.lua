...
function c11845050.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c11845050.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c11845050.effcon(e, tp, eg, ep, ev, re, r, rp)
  ...
  return r == REASON_XYZ and c:IsPreviousLocation(LOCATION_ONFIELD) and not mg:IsExists(c11845050.cfilter, 1, nil) and mg:FilterCount(Card.IsXyzType, nil, TYPE_MONSTER) == mg:GetCount()
end

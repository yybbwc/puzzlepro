...
function c79582540.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c79582540.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c79582540.rmtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(Card.IsAbleToRemove, tp, 0, LOCATION_GRAVE, 1, nil) and Duel.IsPlayerCanDraw(tp, 1)
  end

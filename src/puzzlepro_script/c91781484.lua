...
function c91781484.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return c91781484.filter(chkc) and chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(1 - tp)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c91781484.filter, tp, 0, LOCATION_MZONE, 1, nil)
  end

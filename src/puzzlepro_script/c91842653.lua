...
function c91842653.spcon(e, c)
  ...
  return Duel.IsExistingMatchingCard(c91842653.cfilter, tp, LOCATION_ONFIELD, 0, 1, nil) and Duel.CheckReleaseGroupEx(tp, c91842653.spcfilter, 1, REASON_SPSUMMON, false, nil, tp)
end

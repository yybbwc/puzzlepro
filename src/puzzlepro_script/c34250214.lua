...
function c34250214.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c34250214.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c34250214.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c34250214.costfilter, tp, LOCATION_ONFIELD + LOCATION_HAND, 0, 1, nil, tp)
  end

...
function c25273572.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c25273572.filter, tp, LOCATION_DECK, 0, 1, nil, e, tp, ft)
  end
end
...
function c25273572.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c25273572.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

...
function c99243014.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetCustomActivityCount(99243014, tp, ACTIVITY_SPSUMMON) == 0
  end
...
function c99243014.target(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c99243014.ffilter, tp, LOCATION_EXTRA, 0, 1, nil, e, tp, ft)
  end

...
function c37679169.adcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c37679169.cfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c37679169.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c37679169.spfilter, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end

...
function c49513164.settg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and c49513164.setfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c49513164.setfilter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil)
  end

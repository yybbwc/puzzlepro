...
function c1487805.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c1487805.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c1487805.sumtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c1487805.sumfilter, tp, LOCATION_HAND + LOCATION_MZONE, 0, 1, nil)
  end

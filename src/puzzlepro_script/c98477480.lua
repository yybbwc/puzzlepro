...
function s.cfilter1(c, tp)
  return c:IsFaceup() and c:IsCode(25801745) and Duel.IsExistingMatchingCard(s.cfilter2, tp, LOCATION_MZONE, 0, 1, c)
end
...
function s.filter(c)
  return (c:IsSetCard(0x1a6) or c:IsSetCard(0x2052) and c:GetType() & 0x81 == 0x81) and c:IsAbleToHand() and not c:IsCode(id)
end

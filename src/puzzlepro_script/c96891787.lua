...
function c96891787.atktg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and c96891787.atkfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c96891787.atkfilter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil)
  end

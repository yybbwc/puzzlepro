...
function c91258852.thtg1(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c91258852.thfilter1, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c91258852.thfilter2(c, tp)
  return c:IsCode(54631665) and c:IsAbleToHand() and Duel.IsExistingMatchingCard(c91258852.thfilter3, tp, LOCATION_DECK, 0, 1, c)
end
...
function c91258852.thtg2(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c91258852.thfilter2, tp, LOCATION_DECK, 0, 1, nil, tp)
  end
  Duel.SetOperationInfo(0, CATEGORY_TOHAND, nil, 1, tp, LOCATION_DECK)
end

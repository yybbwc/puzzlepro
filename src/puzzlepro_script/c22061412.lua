...
function c22061412.thtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsControler(tp) and chkc:IsLocation(LOCATION_REMOVED) and c22061412.filter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c22061412.filter, tp, LOCATION_REMOVED, 0, 1, nil)
  end

...
function c27170599.condition(e, tp, eg, ep, ev, re, r, rp)
  return Duel.IsExistingMatchingCard(c27170599.confilter1, tp, LOCATION_FZONE, 0, 1, nil) or Duel.IsExistingMatchingCard(c27170599.confilter2, tp, LOCATION_MZONE, 0, 1, nil)
end
function c27170599.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsControler(1 - tp) and chkc:IsFaceup() and chkc:IsLocation(LOCATION_MZONE)
  end
  if chk == 0 then

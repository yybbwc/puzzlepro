...
function c84171830.discon(e)
  ...
  return Duel.GetFieldGroupCount(tp, LOCATION_EXTRA, 0) == 0 and Duel.IsExistingMatchingCard(c84171830.cfilter, tp, LOCATION_MZONE, 0, 1, nil) and not Duel.IsExistingMatchingCard(c84171830.cfilter, tp, 0, LOCATION_MZONE, 1, nil)
end
...
function c84171830.lvtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c84171830.filter, tp, LOCATION_HAND, 0, 1, nil)
  end
end

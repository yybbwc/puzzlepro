...
function s.lvtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(s.filter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, e:GetHandler()) and e:GetHandler():IsLevelAbove(1)
  end
end
...
function s.descon(e, tp, eg, ep, ev, re, r, rp)
  if not e:GetHandler():IsLevelAbove(8) then
    return false
  end

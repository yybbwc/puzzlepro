...
function c98358303.rmtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c98358303.filter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c98358303.spcon(e, tp, eg, ep, ev, re, r, rp)
  ...
  local c = e:GetHandler()
  return tc and Duel.GetTurnCount() ~= tc:GetTurnID() and c:GetFlagEffect(98358303) ~= 0 and tc:GetFlagEffect(98358303) ~= 0
end

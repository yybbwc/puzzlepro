...
function c70916046.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c70916046.filter, tp, 0, LOCATION_MZONE, 1, nil) and Duel.GetFieldGroupCount(tp, 0, LOCATION_ONFIELD) > 0
  end
  local t = {}
  local i = 1
  for i = 1, 6 do

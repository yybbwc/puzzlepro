...
function c14124483.atktg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and c14124483.atkfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c14124483.atkfilter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil)
  end
...
function c14124483.atkcost2(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c14124483.costfilter, tp, LOCATION_HAND, 0, 1, nil)
  end

...
function c53754104.postg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(tp) and c53754104.pfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c53754104.pfilter, tp, LOCATION_MZONE, 0, 1, nil)
  end

...
function c18235577.lvtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and c18235577.lvfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c18235577.lvfilter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil)
  end

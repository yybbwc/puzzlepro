...
function c80831721.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c80831721.filter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c80831721.atkcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c80831721.rfilter, tp, LOCATION_GRAVE, 0, 3, nil)
  end

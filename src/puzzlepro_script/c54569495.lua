...
function c54569495.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c54569495.costfilter, tp, LOCATION_HAND, 0, 1, c)
  end
...
function c54569495.damtg1(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c54569495.damfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end
end

...
function c36187051.thtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and c36187051.thfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c36187051.thfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end
...
function c36187051.tgtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c36187051.tgfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

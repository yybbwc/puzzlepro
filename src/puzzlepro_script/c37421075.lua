...
function c37421075.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  e:SetLabel(1)
  if chk == 0 then
    return Duel.CheckReleaseGroup(tp, c37421075.cfilter, 1, nil)
  end
...
function c37421075.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    ...
    return not Duel.IsPlayerAffectedByEffect(tp, 59822133) and Duel.IsExistingMatchingCard(c37421075.spfilter, tp, LOCATION_HAND + LOCATION_GRAVE, 0, 2, nil, e, tp) and ((chkf and ft > 0) or (not chkf and ft > 1))
  end

...
function c57728570.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.CheckReleaseGroup(tp, c57728570.costfilter, 1, nil)
  end
...
function c57728570.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c57728570.hgfilter, tp, 0, LOCATION_HAND, 1, nil) or Duel.IsExistingMatchingCard(c57728570.fgfilter, tp, 0, LOCATION_MZONE, 1, nil)
  end

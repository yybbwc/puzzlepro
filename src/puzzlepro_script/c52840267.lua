...
function c52840267.drcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return e:GetHandler():IsDiscardable() and Duel.IsExistingMatchingCard(c52840267.cfilter, tp, LOCATION_HAND, 0, 1, e:GetHandler())
  end
...
function c52840267.cptg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(c52840267.cpfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

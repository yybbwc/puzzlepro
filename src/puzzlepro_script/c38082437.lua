...
function c38082437.opa(e, tp, eg, ep, ev, re, r, rp)
  ...
  if Duel.Recover(tp, rec, REASON_EFFECT) > 0 and g:GetCount() > 0 and Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.SelectYesNo(tp, aux.Stringid(38082437, 1)) then
    Duel.BreakEffect()

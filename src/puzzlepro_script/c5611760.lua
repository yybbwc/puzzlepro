...
function c5611760.activate(e, tp, eg, ep, ev, re, r, rp)
  if Duel.GetFlagEffect(tp, 5611760) ~= 0 then
    return
  end
...
function c5611760.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c5611760.thfilter1, tp, LOCATION_DECK, 0, 1, nil) and Duel.IsExistingMatchingCard(c5611760.thfilter2, tp, LOCATION_DECK, 0, 1, nil)
  end
  Duel.SetOperationInfo(0, CATEGORY_TOHAND, nil, 2, tp, LOCATION_DECK)
end
function c5611760.thop(e, tp, eg, ep, ev, re, r, rp)
  if Duel.GetFlagEffect(tp, 5611761) ~= 0 then
    return
  end

...
function c2089016.atktg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    ...
    e:SetLabel(0)
    return Duel.IsExistingMatchingCard(c2089016.costfilter, tp, LOCATION_DECK + LOCATION_EXTRA, 0, 1, nil) and Duel.IsExistingTarget(Card.IsFaceup, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil)
  end
  e:SetLabel(0)

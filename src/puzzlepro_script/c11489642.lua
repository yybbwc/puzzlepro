...
function s.descon(e, tp, eg, ep, ev, re, r, rp)
  return Duel.IsExistingMatchingCard(s.desfilter, tp, LOCATION_ONFIELD, 0, 1, nil, 7903368) and Duel.IsExistingMatchingCard(s.desfilter, tp, LOCATION_ONFIELD, 0, 1, nil, 58996839) and Duel.IsExistingMatchingCard(s.desfilter, tp, LOCATION_ONFIELD, 0, 1, nil, 84384943)
end
...
function s.drtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return g:GetClassCount(Card.GetCode) >= 3 and Duel.IsPlayerCanDraw(tp, 3)
  end

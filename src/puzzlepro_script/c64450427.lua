...
function c64450427.spcon(e, tp, eg, ep, ev, re, r, rp)
  return not Duel.IsExistingMatchingCard(c64450427.cfilter, tp, LOCATION_MZONE, 0, 1, nil) and Duel.IsExistingMatchingCard(c64450427.cfilter, tp, 0, LOCATION_MZONE, 1, nil)
end

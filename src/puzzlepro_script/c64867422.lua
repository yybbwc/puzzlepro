...
function c64867422.extg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(tp) and c64867422.exfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c64867422.exfilter, tp, LOCATION_MZONE, 0, 1, nil)
  end

...
function c75180828.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c75180828.cfilter, tp, LOCATION_HAND, 0, 4, e:GetHandler())
  end
...
function c75180828.atkcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.CheckReleaseGroup(tp, c75180828.rfilter, 1, e:GetHandler())
  end
...
function c75180828.atktg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return e:GetHandler():GetFlagEffect(75180828) == 0
  end
end
...
function c75180828.destg2(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.GetAttacker() == e:GetHandler() and d ~= nil and d:IsDefensePos()
  end

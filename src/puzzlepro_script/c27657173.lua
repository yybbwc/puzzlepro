...
function c27657173.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c27657173.filter, tp, LOCATION_HAND + LOCATION_DECK, 0, 1, nil)
  end
...
function c27657173.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c27657173.thfilter, tp, LOCATION_DECK + LOCATION_GRAVE, 0, 1, nil)
  end

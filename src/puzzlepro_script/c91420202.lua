...
function c91420202.thtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and c91420202.thfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c91420202.thfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end
...
function c91420202.atkcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c91420202.atkcfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

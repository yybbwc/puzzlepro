...
function c30411385.thtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsControler(tp) and chkc:IsLocation(LOCATION_GRAVE) and c30411385.thfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c30411385.thfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

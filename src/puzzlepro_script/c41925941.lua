...
function c41925941.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.CheckLPCost(tp, 100, true) and (bc:IsAttackAbove(100) or bc:IsDefenseAbove(100))
  end
...
function c41925941.operation(e, tp, eg, ep, ev, re, r, rp)
  ...
  if not bc or not bc:IsRelateToEffect(e) or not bc:IsControler(1 - tp) then
    return
  end

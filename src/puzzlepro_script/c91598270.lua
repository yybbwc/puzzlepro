...
function c91598270.srtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c91598270.srfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c91598270.actcon(e)
  ...
  return a and a:IsControler(tp) and a:IsSetCard(0x162) and a:IsType(TYPE_PENDULUM) and Duel.IsExistingMatchingCard(c91598270.pfilter, tp, LOCATION_PZONE, 0, 1, nil)
end

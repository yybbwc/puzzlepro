...
function c60417395.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return ft > -1 and Duel.IsExistingMatchingCard(c60417395.cfilter1, tp, LOCATION_MZONE, 0, 1, nil, ft) and Duel.IsExistingMatchingCard(c60417395.cfilter2, tp, LOCATION_HAND, 0, 1, e:GetHandler())
  end
...
function c60417395.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c60417395.filter, tp, LOCATION_ONFIELD, 0, 1, nil)
  end

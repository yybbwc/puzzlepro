...
function c18444733.destg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(Card.IsType, tp, LOCATION_ONFIELD, LOCATION_ONFIELD, 1, xg, TYPE_SPELL + TYPE_TRAP) and Duel.IsExistingMatchingCard(c18444733.rmfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

...
function c23837054.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    ...
    return Duel.IsPlayerCanSpecialSummonMonster(tp, 23837055, 0, TYPES_TOKEN_MONSTER, 0, 0, 2, RACE_REPTILE, ATTRIBUTE_DARK) or cg:GetClassCount(Card.GetCode) >= 8 and tg:GetClassCount(Card.GetCode) >= 2
  end

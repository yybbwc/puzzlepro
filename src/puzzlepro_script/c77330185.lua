...
function c77330185.condition(e, tp, eg, ep, ev, re, r, rp)
  return bit.band(e:GetHandler():GetReason(), 0x41) == 0x41 and e:GetHandler():IsPreviousLocation(LOCATION_ONFIELD)
end
...
function c77330185.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c77330185.filter, tp, LOCATION_DECK, 0, 1, nil)
  end

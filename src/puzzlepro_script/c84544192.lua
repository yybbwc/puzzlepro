...
function s.tdcost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return c:GetBattledGroupCount() == 0 and c:IsReleasable()
  end
...
function s.tdtg(e, tp, eg, ep, ev, re, r, rp, chk)
  local c = e:GetHandler()
  if chk == 0 then
    return Duel.IsExistingMatchingCard(Card.IsAbleToDeck, tp, LOCATION_ONFIELD, LOCATION_ONFIELD, 1, c) and Duel.IsExistingMatchingCard(s.spfilter, tp, LOCATION_REMOVED, 0, 1, nil, e, tp)
  end

...
function c73539069.thtg1(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c73539069.thfilter1, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c73539069.thtg2(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(Card.IsFaceup, tp, LOCATION_MZONE, 0, 1, nil) and Duel.IsExistingTarget(c73539069.thfilter2, tp, LOCATION_GRAVE, 0, 1, nil)
  end

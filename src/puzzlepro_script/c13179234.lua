...
function c13179234.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c13179234.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c13179234.pstg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return (Duel.CheckLocation(tp, LOCATION_PZONE, 0) or Duel.CheckLocation(tp, LOCATION_PZONE, 1)) and Duel.IsExistingMatchingCard(c13179234.psfilter, tp, LOCATION_EXTRA, 0, 1, nil)
  end
end

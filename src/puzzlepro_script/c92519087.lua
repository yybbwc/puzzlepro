...
function c92519087.rttg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c92519087.tgfilter, tp, LOCATION_REMOVED, LOCATION_REMOVED, 1, nil)
  end
...
function c92519087.fselect(g)
  return g:GetClassCount(Card.GetOriginalRace) == g:GetCount() and g:GetClassCount(Card.GetOriginalAttribute) == g:GetCount()
end
...
function c92519087.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return g:CheckSubGroup(c92519087.fselect, 2, 2)
  end

...
function c63362460.destg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsOnField() and chkc:IsControler(1 - tp) and c63362460.desfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c63362460.desfilter, tp, 0, LOCATION_ONFIELD, 1, nil)
  end
...
function c63362460.drcost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return c:IsAbleToRemoveAsCost() and Duel.IsExistingMatchingCard(c63362460.cfilter, tp, LOCATION_GRAVE, 0, 1, c)
  end

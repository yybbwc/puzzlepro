...
function c31061682.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > -1 and Duel.IsExistingMatchingCard(c31061682.spfilter, tp, LOCATION_HAND, 0, 1, nil, e, tp)
  end
...
function c31061682.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c31061682.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

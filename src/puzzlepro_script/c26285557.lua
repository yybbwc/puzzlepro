...
function c26285557.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(c26285557.desfilter, tp, LOCATION_ONFIELD, 0, 1, c, tp) and Duel.IsExistingTarget(c26285557.spfilter, tp, LOCATION_GRAVE, 0, 1, nil, e, tp)
  end

...
function c45178472.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(c45178472.up, tp, LOCATION_ONFIELD, LOCATION_ONFIELD, 2, e:GetHandler()) and Duel.IsExistingTarget(c45178472.down, tp, LOCATION_ONFIELD, LOCATION_ONFIELD, 3, e:GetHandler())
  end

...
function c72006609.thcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c72006609.costfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c72006609.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c72006609.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

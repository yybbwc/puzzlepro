...
function c27134209.sprcon(e, c)
  ...
  return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c27134209.sprfilter, tp, LOCATION_GRAVE + LOCATION_HAND, 0, 3, c)
end
...
function c27134209.destg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c27134209.desfilter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil)
  end

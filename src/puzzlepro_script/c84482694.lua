...
function c84482694.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  e:SetLabel(1)
  if chk == 0 then
    return Duel.CheckReleaseGroup(tp, c84482694.costfilter, 1, nil, tp)
  end
...
function c84482694.target(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    e:SetLabel(0)
    return res and not Duel.IsPlayerAffectedByEffect(tp, 59822133) and Duel.IsExistingMatchingCard(c84482694.spfilter, tp, LOCATION_DECK, 0, 2, nil, e, tp)
  end

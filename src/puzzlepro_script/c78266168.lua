...
function c78266168.target(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return c:IsCanTurnSet() and c:GetFlagEffect(78266168) == 0
  end
...
function c78266168.descon(e, tp, eg, ep, ev, re, r, rp)
  return aux.dsercon(e, tp, eg, ep, ev, re, r, rp) and Duel.GetAttackTarget() == e:GetHandler() and e:GetHandler():GetBattlePosition() == POS_FACEDOWN_DEFENSE and Duel.GetAttacker():GetAttack() < e:GetHandler():GetDefense()
end

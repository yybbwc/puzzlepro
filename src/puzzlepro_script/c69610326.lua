...
function c69610326.pctg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return (Duel.CheckLocation(tp, LOCATION_PZONE, 0) or Duel.CheckLocation(tp, LOCATION_PZONE, 1)) and Duel.IsExistingMatchingCard(c69610326.pcfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
end
...
function c69610326.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c69610326.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

...
function s.initial_effect(c)
  c:EnableReviveLimit()
  --material
  aux.AddFusionProcFunFunRep(c, aux.FilterBoolFunction(Card.IsFusionSetCard, 0x1b9), aux.FilterBoolFunction(Card.IsType, TYPE_NORMAL), 1, 127, true)
  --summon success

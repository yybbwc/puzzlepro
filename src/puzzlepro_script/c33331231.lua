...
function c33331231.spcon(e, c)
  ...
  return Duel.IsExistingMatchingCard(c33331231.checkfilter, tp, LOCATION_MZONE, 0, 1, nil) and Duel.IsExistingMatchingCard(c33331231.sprfilter, tp, LOCATION_MZONE, 0, 1, nil, tp, tp)
end
...
function c33331231.spcon2(e, c)
  ...
  local tp = c:GetControler()
  return Duel.IsExistingMatchingCard(c33331231.checkfilter, tp, LOCATION_MZONE, 0, 1, nil) and Duel.IsExistingMatchingCard(c33331231.sprfilter, tp, 0, LOCATION_MZONE, 1, nil, 1 - tp, tp)
end

...
function c58827995.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return sg:CheckSubGroup(c58827995.fselect, 1, sg:GetCount(), tp)
  end
...
function c58827995.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return e:GetHandler():IsAbleToRemove() and Duel.IsExistingMatchingCard(c58827995.spfilter, tp, LOCATION_GRAVE, 0, 1, nil, e, tp)
  end

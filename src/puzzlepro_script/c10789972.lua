...
function c10789972.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and c10789972.filter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c10789972.filter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

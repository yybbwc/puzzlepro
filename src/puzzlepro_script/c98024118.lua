...
function c98024118.filter(c, tp)
  return c:IsLocation(LOCATION_GRAVE) and c:IsReason(REASON_BATTLE) and c:IsType(TYPE_TUNER) and c:IsPreviousControler(tp) and c:IsPreviousPosition(POS_FACEUP)
end

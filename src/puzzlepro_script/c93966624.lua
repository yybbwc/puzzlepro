...
function c93966624.rmtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(c93966624.rmfilter, tp, LOCATION_ONFIELD, 0, 1, nil) and Duel.IsExistingTarget(c93966624.rmfilter, tp, 0, LOCATION_ONFIELD, 1, nil) and Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and e:GetHandler():IsCanBeSpecialSummoned(e, 0, tp, false, false)
  end

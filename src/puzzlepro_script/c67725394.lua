...
function c67725394.sumcon(e, tp, eg, ep, ev, re, r, rp)
  return Duel.IsExistingMatchingCard(c67725394.cfilter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil) and (Duel.GetCurrentPhase() == PHASE_MAIN1 or Duel.GetCurrentPhase() == PHASE_MAIN2)
end

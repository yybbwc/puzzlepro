...
function c72181263.desfilter1(c, tp, ec)
  return c:IsType(TYPE_SPELL + TYPE_TRAP) and Duel.IsExistingTarget(c72181263.desfilter2, tp, LOCATION_ONFIELD, 0, 1, c, ec)
end
...
function c72181263.destg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(c72181263.desfilter1, tp, LOCATION_ONFIELD, LOCATION_ONFIELD, 1, nil, tp, c)
  end

...
function c52534264.atktg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return e:GetHandler():GetFlagEffect(52534264) == 0 and Duel.IsExistingTarget(c52534264.filter1, tp, LOCATION_MZONE, 0, 1, e:GetHandler())
  end
...
function c52534264.tdcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c52534264.costfilter, tp, LOCATION_HAND, 0, 1, nil)
  end

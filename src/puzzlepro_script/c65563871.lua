...
function c65563871.rectg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and c65563871.recfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c65563871.recfilter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil)
  end

...
function c95204084.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c95204084.cfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c95204084.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c95204084.filter, tp, 0, LOCATION_MZONE, 1, nil)
  end

...
function c95923441.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return tc and tc:IsFaceup() and tc:IsSetCard(0xe2) and tc:IsAbleToGrave() and tc:IsCanBeEffectTarget(e) and Duel.IsExistingMatchingCard(c95923441.filter, tp, LOCATION_DECK, 0, 1, nil, tp, tc:GetCode())
  end

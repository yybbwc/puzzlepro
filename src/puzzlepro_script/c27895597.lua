...
function c27895597.tfilter(c, e, tp)
  return c:IsSetCard(0x31) and c:IsCanBeSpecialSummoned(e, 0, tp, false, false) and not Duel.IsExistingMatchingCard(c27895597.bfilter, tp, LOCATION_ONFIELD, 0, 1, nil, c)
end
...
function c27895597.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c27895597.tfilter, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end

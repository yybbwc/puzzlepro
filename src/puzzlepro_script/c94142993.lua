...
function c94142993.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c94142993.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c94142993.tgtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c94142993.tgfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

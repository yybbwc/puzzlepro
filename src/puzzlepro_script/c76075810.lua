...
function c76075810.descost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.CheckReleaseGroup(tp, Card.IsRace, 1, c, RACE_WARRIOR)
  end
...
function c76075810.destg(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c76075810.filter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil, atk)
  end

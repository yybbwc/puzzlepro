...
function c816427.rmcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c816427.costfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c816427.tgtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c816427.tgfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

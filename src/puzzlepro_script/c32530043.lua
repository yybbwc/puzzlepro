...
function c32530043.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c32530043.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c32530043.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c32530043.spfilter, tp, LOCATION_HAND, 0, 1, nil, e, tp)
  end

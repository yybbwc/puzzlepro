...
function c99004583.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetFlagEffect(tp, 99004583) == 0 or Duel.GetFlagEffect(1 - tp, 99004583) == 0
  end
end
...
function c99004583.setcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c99004583.costfilter, tp, LOCATION_HAND, 0, 1, nil)
  end

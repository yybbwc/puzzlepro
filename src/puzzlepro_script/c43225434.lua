...
function c43225434.condition(e, tp, eg, ep, ev, re, r, rp)
  ...
  return at and ((a:IsControler(tp) and a:IsType(TYPE_FUSION)) or (at:IsControler(tp) and at:IsFaceup() and at:IsType(TYPE_FUSION)))
end
function c43225434.activate(e, tp, eg, ep, ev, re, r, rp)
  ...
  if not a:IsRelateToBattle() or a:IsFacedown() or not at:IsRelateToBattle() or at:IsFacedown() then
    return
  end

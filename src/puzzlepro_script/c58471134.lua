...
function c58471134.thcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c58471134.cfilter, tp, LOCATION_HAND, 0, 1, e:GetHandler())
  end
...
function c58471134.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c58471134.filter, tp, LOCATION_DECK, 0, 1, nil)
  end

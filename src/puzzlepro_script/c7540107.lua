...
function c7540107.atktg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c7540107.atkfilter, tp, LOCATION_MZONE, 0, 1, nil)
  end
end
...
function c7540107.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c7540107.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

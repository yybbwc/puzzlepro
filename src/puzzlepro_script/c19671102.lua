...
function c19671102.postg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c19671102.filter, tp, LOCATION_HAND, 0, 1, nil) and Duel.IsExistingMatchingCard(c19671102.posfilter, tp, LOCATION_MZONE, 0, 1, nil)
  end

...
function s.thcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.CheckReleaseGroupEx(tp, s.cfilter1, 1, REASON_COST, true, nil, tp)
  end
...
function s.lptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(aux.AND(Card.IsSetCard, Card.IsFaceup), tp, LOCATION_MZONE, 0, 1, nil, 0x1bc)
  end

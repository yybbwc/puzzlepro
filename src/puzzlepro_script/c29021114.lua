...
function c29021114.sptg1(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c29021114.spfilter1, tp, LOCATION_HAND, 0, 1, nil, e, tp)
  end
...
function c29021114.sptg2(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c29021114.spfilter2, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end

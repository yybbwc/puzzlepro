...
function c94689206.spcon(e, c)
  ...
  return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c94689206.spfilter, tp, LOCATION_GRAVE + LOCATION_HAND, 0, 3, c)
end
...
function c94689206.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return g:CheckWithSumEqual(Card.GetLevel, 8, 1, 3)
  end

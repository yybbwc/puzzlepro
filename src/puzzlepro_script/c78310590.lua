...
function c78310590.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c78310590.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c78310590.sptg2(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c78310590.spfilter, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end

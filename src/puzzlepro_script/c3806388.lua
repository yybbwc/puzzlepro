...
function s.spcost1(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.IsExistingMatchingCard(s.costfilter, tp, LOCATION_HAND + LOCATION_GRAVE, 0, 1, c)
  end
...
function s.spfilter(c, e, tp)
  return c:IsCode(77312273) and c:IsFaceup() and c:IsCanBeSpecialSummoned(e, 0, tp, false, false)
end

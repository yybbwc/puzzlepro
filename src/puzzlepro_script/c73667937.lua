...
function c73667937.damtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and c73667937.damfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c73667937.damfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

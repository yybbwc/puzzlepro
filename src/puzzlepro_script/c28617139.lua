...
function c28617139.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c28617139.costfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c28617139.lvtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c28617139.cffilter, tp, LOCATION_HAND, 0, 1, nil)
  end
end

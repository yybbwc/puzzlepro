...
function c43218406.destg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c43218406.desfilter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil)
  end
...
function c43218406.checkop(e, tp, eg, ep, ev, re, r, rp)
  if Duel.GetFlagEffect(tp, 43218406) ~= 0 then
    return
  end
...
function c43218406.retg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c43218406.filter, tp, 0, LOCATION_GRAVE, 1, nil)
  end

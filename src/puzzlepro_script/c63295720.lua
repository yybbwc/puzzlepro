...
function s.tdfilter(c, tp)
  return c:IsAbleToDeck() and c:IsRace(RACE_DRAGON) and c:IsLevel(8) and Duel.IsExistingMatchingCard(s.thfilter, tp, LOCATION_DECK, 0, 1, nil, c:GetAttribute())
end
...
function s.negcon(e, tp, eg, ep, ev, re, r, rp)
  ...
  return g and g:IsExists(s.negfilter, 1, nil, tp) and Duel.IsChainDisablable(ev)
end

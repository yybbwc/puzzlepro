...
function c34022290.rmcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return e:GetHandler():GetEquipGroup():IsExists(c34022290.cfilter, 1, nil, tp)
  end
...
function c34022290.rmtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(1 - tp) and c34022290.rmfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c34022290.rmfilter, tp, 0, LOCATION_GRAVE, 1, nil)
  end

...
function c36736723.thtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsControler(tp) and chkc:IsLocation(LOCATION_GRAVE) and c36736723.filter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c36736723.filter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

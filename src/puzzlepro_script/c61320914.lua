...
function c61320914.spcost1(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.CheckReleaseGroup(tp, c61320914.cfilter1, 1, nil, tp)
  end
...
function c61320914.sptg1(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsPlayerCanSpecialSummonMonster(tp, 61320914, 0x5008, TYPE_MONSTER + TYPE_EFFECT, 900, 1100, 3, RACE_WARRIOR, ATTRIBUTE_DARK)
  end
...
function c61320914.destg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c61320914.desfilter, tp, 0, LOCATION_MZONE, 1, nil)
  end

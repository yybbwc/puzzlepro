...
function c47840168.effcon(e, tp, eg, ep, ev, re, r, rp)
  ...
  return r == REASON_XYZ and c:IsPreviousLocation(LOCATION_ONFIELD) and not mg:IsExists(c47840168.cfilter2, 1, nil) and mg:FilterCount(Card.IsXyzType, nil, TYPE_MONSTER) == mg:GetCount()
end

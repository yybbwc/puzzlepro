...
function c35618217.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c35618217.costfilter, tp, LOCATION_DECK + LOCATION_EXTRA, 0, 1, nil, c)
  end
...
function c35618217.thtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and c35618217.thfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c35618217.thfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

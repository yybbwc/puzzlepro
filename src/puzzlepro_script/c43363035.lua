...
function s.spop(e, tp, eg, ep, ev, re, r, rp)
  ...
  if Duel.SendtoGrave(sg, REASON_EFFECT) ~= 0 then
    ...
    if ct ~= 0 and c:IsRelateToEffect(e) and Duel.SpecialSummon(c, 0, tp, tp, false, false, POS_FACEUP) ~= 0 and Duel.IsExistingMatchingCard(Card.IsAbleToGrave, tp, 0, LOCATION_ONFIELD, 1, nil) then
      Duel.BreakEffect()

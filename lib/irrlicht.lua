...
do
  ...
  --~ before_build(function(target)
    --~ os.rm(dir_path .. "source/Irrlicht/CIrrDeviceWin32.cpp")
  --~ end)
end
...
--~ do
  ...
  --~ end
--~ end
--~ local target_name = "irrlicht_CMainMenu"
--~ target(target_name)
--~ do
  --~ set_kind("binary")
  --~ do
  ...
  --~ do
    --~ local k1 = {}
    --~ k1[#k1 + 1] = dir_path .. "examples/Demo/*.cpp"
    --~ k1[#k1 + 1] = dir_path .. "examples/Demo/*.rc"
    --~ for i = 1, #k1 do
      --~ add_files(k1[i])
    --~ end
  --~ end
--~ end
--~ local target_name = "irrlicht_SpecialFX"
--~ target(target_name)
--~ do
  --~ set_kind("binary")
  --~ do
  ...
  --~ do
    --~ local k1 = {}
    --~ k1[#k1 + 1] = dir_path .. "examples/08.SpecialFX/*.cpp"
    --~ for i = 1, #k1 do
      --~ add_files(k1[i])
    --~ end
  --~ end

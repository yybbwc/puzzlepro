...
function c72386290.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c72386290.filter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c72386290.sttg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c72386290.stfilter, tp, LOCATION_DECK + LOCATION_GRAVE, 0, 1, nil)
  end
end

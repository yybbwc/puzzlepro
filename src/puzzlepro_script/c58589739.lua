...
function c58589739.postg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(1 - tp) and c58589739.posfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c58589739.posfilter, tp, 0, LOCATION_MZONE, 1, nil)
  end

...
function c65268179.sptg1(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c65268179.spfilter, tp, LOCATION_GRAVE, 0, 1, nil, e, tp)
  end
...
function c65268179.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c65268179.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

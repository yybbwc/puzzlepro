...
function c88685329.drcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c88685329.drfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end
  local ct = 2
...
function c88685329.reptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return e:GetHandler():IsReason(REASON_BATTLE) and Duel.IsExistingMatchingCard(c88685329.repfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

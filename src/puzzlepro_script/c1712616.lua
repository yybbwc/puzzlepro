...
function c1712616.condition(e, tp, eg, ep, ev, re, r, rp)
  return rp ~= tp and re:IsActiveType(TYPE_MONSTER) and Duel.IsChainNegatable(ev) and Duel.IsExistingMatchingCard(c1712616.cfilter1, tp, LOCATION_MZONE, 0, 1, nil)
end
...
function c1712616.setcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c1712616.costfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

...
function c97211663.thcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return e:GetHandler():IsAbleToRemoveAsCost() and Duel.IsExistingMatchingCard(c97211663.cfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end
...
function c97211663.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c97211663.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

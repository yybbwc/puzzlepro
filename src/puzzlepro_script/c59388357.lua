...
function c59388357.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return ft > -1 and Duel.IsExistingTarget(c59388357.desfilter, tp, LOCATION_MZONE, 0, 1, nil, ft) and Duel.IsExistingTarget(c59388357.spfilter, tp, LOCATION_GRAVE, 0, 1, nil, e, tp)
  end

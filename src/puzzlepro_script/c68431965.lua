...
function c68431965.lvtg1(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return e:GetHandler():IsRelateToEffect(e) and Duel.IsExistingMatchingCard(c68431965.tgfilter, tp, LOCATION_DECK, 0, 1, nil, e:GetHandler():GetLevel())
  end
...
function c68431965.lvop1(e, tp, eg, ep, ev, re, r, rp)
  ...
  if not c:IsRelateToEffect(e) or c:IsFacedown() or c:IsImmuneToEffect(e) then
    return
  end

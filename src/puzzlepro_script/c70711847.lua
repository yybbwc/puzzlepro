...
function c70711847.spop(e, tp, eg, ep, ev, re, r, rp)
  ...
  if tc and Duel.SendtoGrave(tc, REASON_DISCARD + REASON_EFFECT) ~= 0 and not tc:IsCode(70711847) and Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 then
...
function c70711847.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c70711847.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

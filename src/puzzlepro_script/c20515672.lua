...
function c20515672.tdtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(tp) and c20515672.tdfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c20515672.tdfilter, tp, LOCATION_MZONE, 0, 1, nil)
  end

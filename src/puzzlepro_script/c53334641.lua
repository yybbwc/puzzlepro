...
function c53334641.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c53334641.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c53334641.mttg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return e:GetHandler():IsType(TYPE_XYZ) and Duel.IsExistingMatchingCard(c53334641.mtfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
end

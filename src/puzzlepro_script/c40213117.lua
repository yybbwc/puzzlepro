...
function c40213117.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c40213117.cffilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c40213117.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c40213117.filter, tp, LOCATION_HAND, 0, 1, nil, e, tp)
  end

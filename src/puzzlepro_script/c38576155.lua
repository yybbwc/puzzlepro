...
function c38576155.thcon(e, tp, eg, ep, ev, re, r, rp)
  return Duel.GetFieldGroupCount(tp, LOCATION_MZONE, 0) > 0 and not Duel.IsExistingMatchingCard(c38576155.thcfilter, tp, LOCATION_MZONE, 0, 1, nil)
end
...
function c38576155.activate(e, tp, eg, ep, ev, re, r, rp)
  ...
  if #g > 0 and c38576155.thcon(e, tp, eg, ep, ev, re, r, rp) and Duel.SelectYesNo(tp, aux.Stringid(38576155, 0)) then

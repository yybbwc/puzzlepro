...
function c8809344.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and c8809344.matfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c8809344.matfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

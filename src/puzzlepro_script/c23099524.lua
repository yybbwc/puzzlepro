...
function c23099524.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.CheckReleaseGroup(tp, c23099524.rfilter, 1, nil, tp)
  end
...
function c23099524.thcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.CheckReleaseGroup(tp, c23099524.thcfilter, 1, nil, tp)
  end
...
function c23099524.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c23099524.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

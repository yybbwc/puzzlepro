...
function c79850798.spcon(e, c)
  ...
  return Duel.GetActivityCount(tp, ACTIVITY_BATTLE_PHASE) == 0 and Duel.GetFieldGroupCount(tp, LOCATION_ONFIELD, 0) == 0 and Duel.GetLocationCount(tp, LOCATION_MZONE) > 0
end

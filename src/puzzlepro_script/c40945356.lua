...
function c40945356.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c40945356.cfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c40945356.target1(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c40945356.indfilter, tp, LOCATION_ONFIELD, 0, 1, nil)
  end
end
...
function c40945356.target2(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c40945356.filter, tp, LOCATION_MZONE, 0, 1, nil)
  end
end

...
function c67073561.rmtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  lg:AddCard(c)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and c67073561.rmfilter(chkc, lg)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c67073561.rmfilter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil, lg)
  end

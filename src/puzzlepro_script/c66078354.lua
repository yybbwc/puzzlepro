...
function c66078354.checkop(e, tp, eg, ep, ev, re, r, rp)
  ...
  if c66078354.check(a) then
    Duel.RegisterFlagEffect(0, 66078354, RESET_PHASE + PHASE_END, 0, 1)
  end
  if c66078354.check(d) then
    Duel.RegisterFlagEffect(1, 66078354, RESET_PHASE + PHASE_END, 0, 1)
  end
end
...
function c66078354.settg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c66078354.setfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
end

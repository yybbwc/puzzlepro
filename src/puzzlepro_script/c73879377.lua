...
function c73879377.cfilter(c, tp)
  ...
  return c:IsType(TYPE_MONSTER) and c:IsAbleToGraveAsCost() and Duel.IsExistingMatchingCard(c73879377.dfilter, tp, 0, LOCATION_MZONE, 1, nil, atk)
end
...
function c73879377.descost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c73879377.cfilter, tp, LOCATION_HAND, 0, 1, nil, tp)
  end

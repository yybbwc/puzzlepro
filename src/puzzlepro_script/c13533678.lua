...
function c13533678.spcon(e, c)
  ...
  return Duel.GetLocationCount(c:GetControler(), LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c13533678.filter, c:GetControler(), LOCATION_MZONE, 0, 1, nil)
end
...
function c13533678.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c13533678.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

...
function c15033525.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c15033525.costfilter, tp, LOCATION_GRAVE, 0, 3, e:GetHandler())
  end
...
function c15033525.damcost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return #mg > 0 and not g:IsExists(aux.NOT(Card.IsAbleToGraveAsCost), 1, nil)
  end

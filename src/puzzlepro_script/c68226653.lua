...
function c68226653.thcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return e:GetHandler():IsAbleToRemoveAsCost() and Duel.IsExistingMatchingCard(c68226653.cfilter, tp, LOCATION_MZONE, 0, 1, nil)
  end
...
function c68226653.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c68226653.filter, tp, LOCATION_DECK, 0, 1, nil)
  end

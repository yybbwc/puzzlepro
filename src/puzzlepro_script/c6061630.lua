...
function c6061630.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c6061630.filter, tp, LOCATION_HAND + LOCATION_GRAVE, 0, 1, nil, e:GetHandler(), e, tp)
  end

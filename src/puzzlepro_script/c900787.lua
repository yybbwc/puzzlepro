...
function c900787.condition(e, tp, eg, ep, ev, re, r, rp)
  ...
  return ph == PHASE_DAMAGE and (c == Duel.GetAttacker() or c == Duel.GetAttackTarget()) and not Duel.IsDamageCalculated()
end
...
function c900787.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return e:GetHandler():GetFlagEffect(900787) == 0 and Duel.IsExistingMatchingCard(c900787.cfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

...
function c62405028.tgtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c62405028.tgfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c62405028.srtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c62405028.srfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

...
function c92767273.atktg2(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(tp) and c92767273.atkfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c92767273.atkfilter, tp, LOCATION_MZONE, 0, 1, nil)
  end

...
function c53701259.lpcon(e, tp, eg, ep, ev, re, r, rp)
  return c53701259.condition(e, tp, eg, ep, ev, re, r, rp) and eg:IsExists(c53701259.cfilter, 1, nil, 1 - tp)
end
function c53701259.lpcon1(e, tp, eg, ep, ev, re, r, rp)
  return c53701259.lpcon(e, tp, eg, ep, ev, re, r, rp) and not Duel.IsChainSolving()
end
...
function c53701259.regcon(e, tp, eg, ep, ev, re, r, rp)
  return c53701259.lpcon(e, tp, eg, ep, ev, re, r, rp) and Duel.IsChainSolving()
end
...
function c53701259.discon(e, tp, eg, ep, ev, re, r, rp)
  ...
  return c53701259.condition(e, tp, eg, ep, ev, re, r, rp) and re:IsActiveType(TYPE_MONSTER) and loc == LOCATION_MZONE and rp == 1 - tp
end
...
function c53701259.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c53701259.thfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

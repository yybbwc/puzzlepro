...
function c3113667.spcon2(e, tp, eg, ep, ev, re, r, rp)
  ...
  return tgp == tp and loc == LOCATION_MZONE and rc:GetOriginalAttribute() == ATTRIBUTE_DARK and rc:GetOriginalRace() == RACE_MACHINE and eg:IsExists(c3113667.cfilter, 1, nil)
end
...
function c3113667.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c3113667.spfilter, tp, LOCATION_HAND, 0, 1, nil, e, tp)
  end

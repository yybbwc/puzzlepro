...
function c18514525.atkop(e, tp, eg, ep, ev, re, r, rp)
  ...
  if c:IsFacedown() or not c:IsRelateToEffect(e) or atk < 1000 then
    return
  end
  local e1 = Effect.CreateEffect(c)
...
function c18514525.spfilter(c, e, tp)
  return c:IsSetCard(0x120) and not c:IsType(TYPE_FUSION) and c:IsCanBeEffectTarget(e) and c:IsCanBeSpecialSummoned(e, 0, tp, false, false)
end

...
function c73956664.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c73956664.tgfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c73956664.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and c:IsCanBeSpecialSummoned(e, 0, tp, false, false) and Duel.IsExistingMatchingCard(c73956664.tgfilter2, tp, LOCATION_HAND, 0, 1, nil)
  end

...
function c55521751.otcon(e, c, minc)
  ...
  return minc <= 2 and Duel.IsExistingMatchingCard(c55521751.otfilter, tp, LOCATION_MZONE, 0, 1, nil, e, tp) and Duel.IsExistingMatchingCard(c55521751.otfilter2, tp, 0, LOCATION_ONFIELD, 1, nil, e)
end
...
function c55521751.drtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsPlayerCanDraw(tp) and Duel.IsExistingMatchingCard(c55521751.drfilter, tp, LOCATION_HAND, 0, 1, nil)
  end

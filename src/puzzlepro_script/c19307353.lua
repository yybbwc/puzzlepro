...
function c19307353.cfilter(c, tp)
  ...
  return c:IsAttackAbove(0) and c:IsDefenseAbove(0) and Duel.IsExistingMatchingCard(c19307353.thfilter, tp, LOCATION_DECK, 0, 1, nil, sum)
end
...
function c19307353.thcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.CheckReleaseGroup(tp, c19307353.cfilter, 1, nil, tp)
  end

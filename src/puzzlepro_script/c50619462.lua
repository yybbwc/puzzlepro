...
function c50619462.cfilter(c, e, tp)
  ...
  return c:IsFaceup() and c:IsAbleToGraveAsCost() and (race == RACE_WINDBEAST or race == RACE_BEAST or race == RACE_BEASTWARRIOR) and Duel.IsExistingMatchingCard(c50619462.spfilter, tp, LOCATION_EXTRA, 0, 1, nil, e, tp, race, c)
end

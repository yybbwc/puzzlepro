...
function c23649496.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c23649496.cfilter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil)
  end
...
function c23649496.tgtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c23649496.tgfilter, tp, LOCATION_DECK, 0, 2, nil)
  end

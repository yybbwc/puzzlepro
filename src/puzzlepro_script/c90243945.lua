...
function c90243945.tgtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c90243945.tgfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c90243945.atktg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c90243945.atkfilter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, e:GetHandler())
  end
end

...
function c82661461.atktg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c82661461.atkfilter, tp, LOCATION_EXTRA, 0, 1, nil)
  end
end
...
function c82661461.tgtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c82661461.tgfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

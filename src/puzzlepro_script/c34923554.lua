...
function c34923554.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.CheckReleaseGroup(tp, c34923554.cfilter, 1, nil, tp)
  end
...
function c34923554.thcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c34923554.thcfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end
...
function c34923554.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c34923554.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

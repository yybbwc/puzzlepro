...
function c38837163.spcon(e, c)
  ...
  return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c38837163.spfilter, tp, LOCATION_GRAVE, 0, 2, nil)
end
...
function c38837163.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c38837163.cfilter, tp, LOCATION_HAND, 0, 1, nil)
  end

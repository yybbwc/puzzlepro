...
function c3366982.dircon(e)
  ...
  return Duel.IsExistingMatchingCard(Card.IsFaceup, tp, 0, LOCATION_MZONE, 1, nil) and not Duel.IsExistingMatchingCard(c3366982.filter, tp, 0, LOCATION_MZONE, 1, nil)
end

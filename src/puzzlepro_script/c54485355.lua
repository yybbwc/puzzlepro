...
function c54485355.eqtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_SZONE) > 0 and Duel.IsExistingMatchingCard(c54485355.eqfilter, tp, LOCATION_HAND + LOCATION_DECK, 0, 1, nil, tp)
  end
...
function c54485355.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and g:IsExists(c54485355.spfilter, 1, nil, e, tp)
  end

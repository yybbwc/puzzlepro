...
function c13694209.thtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and c13694209.thfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c13694209.thfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end
...
function c13694209.atktg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c13694209.atkfilter, tp, LOCATION_MZONE, 0, 1, nil)
  end
end

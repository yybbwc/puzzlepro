...
function c51391183.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(Card.IsSetCard, tp, LOCATION_PZONE, 0, 1, e:GetHandler(), 0x10ec)
  end
...
function c51391183.atktg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c51391183.atkfilter, tp, LOCATION_MZONE, 0, 1, nil)
  end
end
...
function c51391183.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c51391183.filter, tp, LOCATION_DECK, 0, 1, nil)
  end

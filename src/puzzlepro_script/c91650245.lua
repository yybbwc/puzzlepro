...
function c91650245.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c91650245.filter, tp, LOCATION_HAND, 0, 1, nil, e, tp)
  end
...
function c91650245.tdop(e, tp, eg, ep, ev, re, r, rp)
  ...
  if c:IsExtraDeckMonster() or Duel.SelectOption(tp, aux.Stringid(91650245, 0), aux.Stringid(91650245, 1)) == 0 then

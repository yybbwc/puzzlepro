...
function c65589010.tgcon(e, tp, eg, ep, ev, re, r, rp)
  ...
  return c:IsPreviousPosition(POS_FACEUP) and c:IsPreviousLocation(LOCATION_FZONE) and c:IsPreviousControler(tp) and c:IsReason(REASON_EFFECT) and c:GetReasonPlayer() == 1 - tp
end

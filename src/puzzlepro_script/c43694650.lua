...
function c43694650.spop(e, tp, eg, ep, ev, re, r, rp)
  ...
  if Duel.SendtoGrave(tc, REASON_DISCARD + REASON_EFFECT) ~= 0 and not tc:IsCode(43694650) and Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 then
...
function c43694650.sptg2(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c43694650.spfilter2, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end

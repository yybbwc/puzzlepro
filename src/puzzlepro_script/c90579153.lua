...
function c90579153.damtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and c90579153.filter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c90579153.filter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

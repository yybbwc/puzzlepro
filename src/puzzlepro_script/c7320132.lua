...
function c7320132.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c7320132.spfilter, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end
...
function c7320132.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c7320132.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

...
do
  ...
  --~ before_build(function(target)
    ...
    --~ else
      --~ local k1 = "build/include/"
      --~ local k2 = "include/IrrCompileConfig.h"
      --~ local k3 = k1 .. "IrrCompileConfig.h"
      --~ os.mkdir(k1)
      --~ os.cp(k2, k3)
      --~ io.gsub(k3, "//#define _IRR_WCHAR_FILESYSTEM", "#define _IRR_WCHAR_FILESYSTEM", {plain = true})
    --~ end
  --~ end)
end

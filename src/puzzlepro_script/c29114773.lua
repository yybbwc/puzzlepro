...
function c29114773.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c29114773.costfilter, tp, LOCATION_HAND, 0, 1, e:GetHandler())
  end
...
function c29114773.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c29114773.filter, tp, LOCATION_DECK, 0, 1, nil)
  end

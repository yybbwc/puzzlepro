...
function c92353449.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c92353449.cfilter, tp, LOCATION_HAND + LOCATION_DECK, 0, 1, nil)
  end
...
function c92353449.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c92353449.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

...
function c66740005.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c66740005.spfilter, tp, LOCATION_HAND, 0, 1, nil, e, tp)
  end
...
function c66740005.atktg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c66740005.atkfilter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil)
  end
end

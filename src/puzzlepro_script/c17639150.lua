...
function c17639150.eqtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and c17639150.eqfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c17639150.eqfilter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil)
  end
...
function c17639150.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c17639150.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

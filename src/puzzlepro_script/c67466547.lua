...
function c67466547.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c67466547.spfilter, tp, LOCATION_HAND, 0, 1, nil, e, tp)
  end
...
function c67466547.drcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c67466547.drcfilter, tp, LOCATION_HAND, 0, 1, nil)
  end

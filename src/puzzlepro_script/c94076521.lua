...
function c94076521.sumtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsPlayerCanSummon(tp) and Duel.IsPlayerCanAdditionalSummon(tp) and Duel.GetFlagEffect(tp, 94076521) == 0
  end
end
...
function c94076521.spcon(e, tp, eg, ep, ev, re, r, rp)
  return Duel.IsExistingMatchingCard(c94076521.cfilter, tp, LOCATION_MZONE, 0, 1, nil, ATTRIBUTE_EARTH) and Duel.IsExistingMatchingCard(c94076521.cfilter, tp, LOCATION_MZONE, 0, 1, nil, ATTRIBUTE_WATER)
end

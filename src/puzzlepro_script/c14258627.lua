...
function c14258627.spcon(e, c)
  ...
  return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c14258627.filter, tp, LOCATION_GRAVE, 0, 2, nil)
end
...
function c14258627.mtop(e, tp, eg, ep, ev, re, r, rp)
  if Duel.IsExistingMatchingCard(c14258627.filter, tp, LOCATION_GRAVE, 0, 1, nil) and Duel.SelectYesNo(tp, aux.Stringid(14258627, 0)) then
    Duel.Hint(HINT_SELECTMSG, tp, HINTMSG_REMOVE)

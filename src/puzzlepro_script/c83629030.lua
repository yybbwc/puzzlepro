...
function c83629030.dircon(e)
  ...
  return Duel.IsExistingMatchingCard(c83629030.cfilter1, tp, LOCATION_ONFIELD, 0, 1, nil) and not Duel.IsExistingMatchingCard(c83629030.cfilter2, tp, 0, LOCATION_MZONE, 1, nil)
end

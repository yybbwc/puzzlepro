...
function c89015998.rmtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(tp) and c89015998.rmfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c89015998.rmfilter, tp, LOCATION_MZONE, 0, 1, nil)
  end

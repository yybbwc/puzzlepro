...
function s.spfilter(c, e, tp)
  return c:IsType(TYPE_MONSTER) and c:IsSetCard(0x1019) and c:IsCanBeSpecialSummoned(e, 0, tp, false, false, POS_FACEUP) and (c:IsLocation(LOCATION_DECK) or c:IsLevelBelow(4))
end

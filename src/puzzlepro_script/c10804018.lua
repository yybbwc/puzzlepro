...
function c10804018.drtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c10804018.cfilter, tp, LOCATION_ONFIELD + LOCATION_GRAVE, 0, 1, nil) and Duel.IsPlayerCanDraw(tp, 2)
  end
...
function c10804018.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c10804018.thfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

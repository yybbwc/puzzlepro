...
function c38742075.distg(e, c)
  return c:GetCardTargetCount() > 0 and c:IsType(TYPE_SPELL) and c:GetCardTarget():IsExists(c38742075.cfilter, 1, nil, e:GetHandlerPlayer())
end
function c38742075.disop(e, tp, eg, ep, ev, re, r, rp)
  ...
  if not g or not g:IsExists(c38742075.cfilter, 1, nil, tp) then
    return
  end

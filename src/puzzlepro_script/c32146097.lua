...
function c32146097.drcon(e, tp, eg, ep, ev, re, r, rp)
  ...
  return (c:IsReason(REASON_BATTLE) or rp == 1 - tp and c:IsReason(REASON_DESTROY) and c:IsPreviousControler(tp)) and Duel.GetFieldGroupCount(tp, LOCATION_ONFIELD, 0) == 0
end

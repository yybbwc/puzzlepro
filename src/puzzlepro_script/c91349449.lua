...
function c91349449.spcon(e, c)
  ...
  return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c91349449.spfilter, tp, LOCATION_REMOVED, 0, 3, nil)
end
...
function c91349449.rmtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(c91349449.filter1, tp, LOCATION_REMOVED, 0, 1, nil) and Duel.IsExistingTarget(c91349449.filter2, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil)
  end

...
function c85374678.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c85374678.filter, tp, LOCATION_HAND, 0, 1, nil, e, tp)
  end
...
function c85374678.drcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c85374678.drcfilter, tp, LOCATION_HAND, 0, 1, nil)
  end

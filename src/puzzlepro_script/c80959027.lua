...
function c80959027.tdtg(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return c:IsDestructable() and Duel.IsExistingMatchingCard(c80959027.tdfilter, tp, LOCATION_EXTRA, 0, 1, nil) and Duel.IsPlayerCanDraw(tp, 1)
  end
...
function c80959027.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c80959027.thfilter, tp, LOCATION_PZONE + LOCATION_EXTRA, 0, 1, nil)
  end

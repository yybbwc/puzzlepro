...
function c82956214.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(1 - tp) and c82956214.desfilter(chkc, tp)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c82956214.desfilter, tp, 0, LOCATION_MZONE, 1, nil, tp)
  end

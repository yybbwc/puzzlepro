...
function c57916305.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c57916305.filter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c57916305.thcon(e, tp, eg, ep, ev, re, r, rp)
  return Duel.GetTurnPlayer() == tp and Duel.IsExistingMatchingCard(c57916305.rccfilter, tp, LOCATION_MZONE, 0, 1, nil)
end

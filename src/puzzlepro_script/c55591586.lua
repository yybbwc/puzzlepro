...
function c55591586.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c55591586.filter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c55591586.tdop(e, tp, eg, ep, ev, re, r, rp)
  ...
  if tc:IsRelateToEffect(e) then
    if tc:IsExtraDeckMonster() or Duel.SelectOption(tp, aux.Stringid(55591586, 4), aux.Stringid(55591586, 5)) == 0 then

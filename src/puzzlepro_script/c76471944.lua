...
function c76471944.destg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and c76471944.desfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c76471944.desfilter, tp, LOCATION_ONFIELD, LOCATION_ONFIELD, 1, nil)
  end

...
function c99458769.spcon(e, tp, eg, ep, ev, re, r, rp)
  return e:GetHandler():IsPreviousLocation(LOCATION_HAND) and bit.band(r, 0x4040) == 0x4040 and rp == 1 - tp and e:GetHandler():IsPreviousControler(tp)
end
...
function c99458769.destg(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if (c1 > c2 and c2 ~= 0) or c1 == 0 then
    c1 = c2
  end
  if c1 ~= 0 then

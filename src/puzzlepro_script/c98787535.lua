...
function c98787535.spop(e, tp, eg, ep, ev, re, r, rp)
  ...
  if c:IsRelateToEffect(e) and Duel.SpecialSummon(c, 0, tp, tp, false, false, POS_FACEUP) ~= 0 and Duel.IsExistingMatchingCard(aux.NecroValleyFilter(c98787535.thfilter), tp, 0, LOCATION_GRAVE, 1, nil, tp) and Duel.SelectYesNo(1 - tp, aux.Stringid(98787535, 2)) then
    Duel.BreakEffect()
...
function c98787535.rgtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return g:CheckSubGroup(c98787535.fselect, 2, 2)
  end

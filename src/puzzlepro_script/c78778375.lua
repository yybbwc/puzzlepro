...
function c78778375.atktg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(tp) and c78778375.atkfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c78778375.atkfilter, tp, LOCATION_MZONE, 0, 1, nil) and Duel.IsExistingMatchingCard(c78778375.tgfilter, tp, LOCATION_DECK + LOCATION_EXTRA, 0, 1, nil)
  end

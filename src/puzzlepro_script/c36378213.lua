...
function c36378213.filter(c, e, tp)
  return c:IsPreviousLocation(LOCATION_GRAVE) and c:IsPreviousControler(tp) and c:IsSetCard(0x16) and c:IsCanBeSpecialSummoned(e, 0, tp, false, false)
end
...
function c36378213.spfilter(c, e, tp)
  return c:IsPreviousLocation(LOCATION_GRAVE) and c:IsPreviousControler(tp) and c:IsSetCard(0x16) and c:IsCanBeSpecialSummoned(e, 0, tp, false, false) and c:IsRelateToEffect(e)
end

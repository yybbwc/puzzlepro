...
function c50750868.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    ...
    return ct > 2 and not Duel.IsPlayerAffectedByEffect(tp, 59822133) and Duel.IsExistingMatchingCard(c50750868.spfilter, tp, LOCATION_HAND, 0, 1, nil, e, tp, zone) and Duel.IsExistingMatchingCard(c50750868.spfilter, tp, LOCATION_GRAVE, 0, 1, nil, e, tp, zone) and Duel.IsExistingMatchingCard(c50750868.spfilter, tp, LOCATION_DECK, 0, 1, nil, e, tp, zone)
  end

...
function c68304193.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c68304193.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c68304193.rmtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c68304193.rmfilter, tp, 0, LOCATION_EXTRA, 1, nil, tp)
  end
...
function c68304193.rmtg2(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return rp == 1 - tp and Duel.IsExistingMatchingCard(c68304193.rmfilter, tp, 0, LOCATION_EXTRA, 1, nil, tp)
  end
  Duel.SetOperationInfo(0, CATEGORY_REMOVE, nil, 1, 1 - tp, LOCATION_EXTRA)
end

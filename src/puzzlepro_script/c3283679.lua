...
function c3283679.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c3283679.tgfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c3283679.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c3283679.spfilter, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end

...
function c46935289.discost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c46935289.disfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c46935289.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c46935289.thfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

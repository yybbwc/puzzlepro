...
function c91822647.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingTarget(c91822647.filter1, tp, LOCATION_GRAVE, 0, 2, nil) and Duel.IsExistingMatchingCard(c91822647.filter2, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end

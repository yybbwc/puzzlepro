...
function c45836982.spcon(e, tp, eg, ep, ev, re, r, rp)
  return Duel.IsExistingMatchingCard(c45836982.cfilter, tp, LOCATION_MZONE, 0, 1, nil) and Duel.IsExistingMatchingCard(Card.IsType, tp, LOCATION_GRAVE, 0, 1, nil, TYPE_SYNCHRO)
end
...
function c45836982.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c45836982.thfilter, tp, LOCATION_DECK + LOCATION_GRAVE, 0, 1, nil)
  end

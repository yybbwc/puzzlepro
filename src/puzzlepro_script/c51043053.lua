...
function c51043053.atcon(e)
  return Duel.GetFieldGroupCount(e:GetHandlerPlayer(), LOCATION_MZONE, 0) == 1 and Duel.GetFieldGroupCount(e:GetHandlerPlayer(), 0, LOCATION_HAND) < 5
end
...
function c51043053.condition(e, tp, eg, ep, ev, re, r, rp)
  return not e:GetHandler():IsLevel(8) and Duel.IsExistingMatchingCard(c51043053.filter, tp, LOCATION_MZONE, 0, 1, nil)
end

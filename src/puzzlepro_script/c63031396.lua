...
function c63031396.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.GetCustomActivityCount(63031396, tp, ACTIVITY_SPSUMMON) == 0 and g:CheckSubGroup(c63031396.fselect, 2, 2, tp)
  end
...
function c63031396.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c63031396.thfilter, tp, LOCATION_DECK, 0, 1, nil) and Duel.IsExistingMatchingCard(c63031396.tgfilter, tp, LOCATION_EXTRA, 0, 1, nil)
  end

...
function c66926224.target(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.IsExistingMatchingCard(nil, tp, LOCATION_HAND, 0, 1, c) and Duel.GetFieldGroupCount(tp, 0, LOCATION_HAND) > 0 and Duel.IsExistingMatchingCard(c66926224.dfilter, tp, LOCATION_ONFIELD, LOCATION_ONFIELD, 1, c)
  end

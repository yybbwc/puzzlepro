...
function c45184165.thtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and c45184165.thfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c45184165.thfilter, tp, LOCATION_GRAVE, 0, 1, e:GetHandler())
  end

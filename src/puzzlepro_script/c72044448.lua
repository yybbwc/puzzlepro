...
function c72044448.condition(e, tp, eg, ep, ev, re, r, rp)
  return Duel.IsExistingMatchingCard(c72044448.cfilter1, tp, LOCATION_MZONE, 0, 1, nil) and (Duel.GetTurnPlayer() == tp or Duel.IsExistingMatchingCard(c72044448.cfilter2, tp, LOCATION_ONFIELD, 0, 1, nil))
end

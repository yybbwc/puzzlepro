...
function c18940725.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c18940725.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c18940725.thop(e, tp, eg, ep, ev, re, r, rp)
  ...
  if g:GetCount() > 0 then
    ...
    if Duel.IsExistingMatchingCard(c18940725.sumfilter, tp, LOCATION_HAND + LOCATION_MZONE, 0, 1, nil) and Duel.SelectYesNo(tp, aux.Stringid(18940725, 2)) then
      Duel.BreakEffect()
      Duel.ShuffleHand(tp)

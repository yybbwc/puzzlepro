...
function c56585883.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(c56585883.filter1, tp, LOCATION_MZONE, 0, 1, e:GetHandler()) and Duel.IsExistingTarget(c56585883.filter2, tp, 0, LOCATION_MZONE, 1, nil)
  end
...
function c56585883.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c56585883.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

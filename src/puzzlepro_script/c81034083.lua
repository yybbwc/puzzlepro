...
function c81034083.thfilter(c)
  return (c:IsCode(6007213, 32491822, 69890967) or ((aux.IsCodeListed(c, 6007213) or aux.IsCodeListed(c, 32491822) or aux.IsCodeListed(c, 69890967)) and not c:IsCode(81034083))) and c:IsAbleToHand()
end
function c81034083.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c81034083.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

...
function c69815951.tgtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsOnField() and chkc:IsControler(1 - tp) and c69815951.tgfilter(chkc)
  end
  ...
  if chk == 0 then
    ...
    return Duel.IsExistingTarget(c69815951.tgfilter, tp, 0, LOCATION_ONFIELD, 1, nil)
  end
  e:SetLabel(0, 0)

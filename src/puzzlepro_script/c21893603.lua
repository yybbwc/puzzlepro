...
function c21893603.thtg1(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c21893603.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c21893603.thcost2(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c21893603.thcfilter, tp, LOCATION_HAND + LOCATION_MZONE, 0, 1, nil)
  end

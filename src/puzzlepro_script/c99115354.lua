...
function c99115354.thfilter1(c, tp)
  return c:IsType(TYPE_MONSTER) and c:IsType(TYPE_TUNER) and c:IsAbleToHand() and Duel.IsExistingTarget(c99115354.thfilter2, tp, LOCATION_GRAVE, 0, 1, c, c:GetAttribute(), c:GetRace())
end
...
function c99115354.thtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(c99115354.thfilter1, tp, LOCATION_GRAVE, 0, 1, nil, tp)
  end

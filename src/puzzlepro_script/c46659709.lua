...
function c46659709.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c46659709.cfilter, tp, LOCATION_HAND, 0, 1, e:GetHandler())
  end
...
function c46659709.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c46659709.filter, tp, LOCATION_DECK, 0, 1, nil)
  end

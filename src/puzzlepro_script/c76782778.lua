...
function c76782778.sptg1(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c76782778.spfilter1, tp, LOCATION_HAND, 0, 1, nil, e, tp)
  end
...
function c76782778.sptg2(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return c:IsAbleToHand() and Duel.GetMZoneCount(tp, c) > 0 and Duel.IsExistingMatchingCard(c76782778.spfilter2, tp, LOCATION_HAND, 0, 1, nil, e, tp)
  end

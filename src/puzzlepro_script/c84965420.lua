...
function c84965420.condition(e, tp, eg, ep, ev, re, r, rp)
  return Duel.IsExistingMatchingCard(c84965420.filter, tp, LOCATION_MZONE, 0, 1, nil) and aux.NegateSummonCondition() and eg:IsExists(c84965420.cfilter, 1, nil, tp)
end

...
function c93729065.copycost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return e:GetHandler():GetFlagEffect(93729065) == 0
  end
...
function c93729065.copytg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsControler(1 - tp) and chkc:IsLocation(LOCATION_MZONE) and c93729065.copyfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c93729065.copyfilter, tp, 0, LOCATION_MZONE, 1, nil)
  end

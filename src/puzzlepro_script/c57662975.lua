...
function c57662975.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c57662975.cfilter, tp, LOCATION_ONFIELD, 0, 1, nil)
  end
...
function c57662975.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c57662975.dfilter, tp, LOCATION_ONFIELD, LOCATION_ONFIELD, 2, nil)
  end

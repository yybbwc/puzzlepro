...
function c14047624.damcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c14047624.cfilter, tp, LOCATION_GRAVE, 0, 1, nil) and not Duel.IsExistingMatchingCard(c14047624.cfilter2, tp, LOCATION_MZONE, 0, 1, nil)
  end

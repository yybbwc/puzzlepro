...
function c80513550.hspcon(e, c)
  ...
  return Duel.GetLocationCount(c:GetControler(), LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c80513550.hspfilter, c:GetControler(), LOCATION_SZONE, 0, 3, nil)
end
...
function c80513550.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c80513550.cfilter, tp, LOCATION_SZONE, 0, 1, nil)
  end

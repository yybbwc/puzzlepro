...
function c84546257.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetCustomActivityCount(84546257, tp, ACTIVITY_SPSUMMON) == 0
  end
...
function c84546257.thcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return c84546257.cost(e, tp, eg, ep, ev, re, r, rp, 0) and Duel.IsExistingMatchingCard(c84546257.costfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c84546257.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c84546257.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c84546257.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return c84546257.cost(e, tp, eg, ep, ev, re, r, rp, 0) and e:GetHandler():IsAbleToRemoveAsCost()
  end

...
function c97997309.target1(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c97997309.filter1, tp, LOCATION_SZONE, LOCATION_SZONE, 1, e:GetHandler())
  end
...
function c97997309.target2(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c97997309.filter2, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil)
  end
...
function c97997309.target3(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c97997309.filter3, tp, 0, LOCATION_ONFIELD, 1, nil)
  end

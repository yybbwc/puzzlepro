...
function c53094821.condition(e, tp, eg, ep, ev, re, r, rp)
  return (re:IsActiveType(TYPE_MONSTER) or re:IsHasType(EFFECT_TYPE_ACTIVATE)) and Duel.IsChainNegatable(ev) and Duel.IsExistingMatchingCard(c53094821.cfilter1, tp, LOCATION_ONFIELD, 0, 1, nil) and Duel.IsExistingMatchingCard(c53094821.cfilter2, tp, LOCATION_MZONE, 0, 1, nil)
end

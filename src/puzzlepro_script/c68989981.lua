...
function c68989981.tgtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c68989981.tgfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c68989981.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c68989981.spfilter, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end

...
function c59778096.tgtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c59778096.tgfilter, tp, 0, LOCATION_MZONE, 1, nil)
  end
...
function c59778096.thcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c59778096.rmfilter, tp, LOCATION_GRAVE, 0, 7, nil)
  end
...
function c59778096.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c59778096.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

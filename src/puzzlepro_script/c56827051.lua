...
function c56827051.lvcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c56827051.cfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c56827051.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c56827051.filter, tp, LOCATION_DECK, 0, 1, nil)
  end

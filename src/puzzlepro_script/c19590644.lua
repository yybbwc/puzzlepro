...
function c19590644.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c19590644.spfilter, tp, LOCATION_HAND + LOCATION_DECK, 0, 1, nil, e, tp, e:GetLabel())
  end

...
function c86690572.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c86690572.cfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c86690572.thcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c86690572.thfilter, tp, LOCATION_GRAVE, 0, 2, nil)
  end
...
function c86690572.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return e:GetHandler():IsAbleToHand() and not e:GetHandler():IsStatus(STATUS_CHAINING)
  end

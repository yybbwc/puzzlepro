...
function c52807032.condition(e, tp, eg, ep, ev, re, r, rp)
  return Duel.IsExistingMatchingCard(c52807032.cfilter, tp, LOCATION_MZONE, 0, 1, nil) and re:IsHasType(EFFECT_TYPE_ACTIVATE) and Duel.IsChainNegatable(ev) and rp == 1 - tp
end

...
function c15013468.spcon(e, c)
  ...
  return Duel.GetLocationCount(c:GetControler(), LOCATION_MZONE) > 0 and Duel.CheckLPCost(c:GetControler(), 500) and Duel.IsExistingMatchingCard(c15013468.cfilter, 0, LOCATION_ONFIELD, LOCATION_ONFIELD, 1, nil)
end

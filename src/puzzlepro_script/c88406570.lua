...
function c88406570.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    ...
    return zone ~= 0 and Duel.GetLocationCount(1 - tp, LOCATION_MZONE, 1 - tp) > 0 and Duel.IsExistingMatchingCard(c88406570.spfilter1, 1 - tp, LOCATION_GRAVE, 0, 1, nil, e, 1 - tp) and Duel.IsExistingMatchingCard(c88406570.spfilter2, tp, LOCATION_GRAVE, 0, 1, nil, e, tp, zone)
  end

...
function c39838559.drcon(e, tp, eg, ep, ev, re, r, rp)
  ...
  return rc:IsRelateToBattle() and rc:IsStatus(STATUS_OPPO_BATTLE) and rc:IsFaceup() and rc:IsSetCard(0x107) and rc:IsControler(tp)
end
...
function c39838559.thtg2(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c39838559.thfilter2, tp, LOCATION_DECK, 0, 1, nil)
  end

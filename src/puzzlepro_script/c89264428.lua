...
function c89264428.tkccost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return e:GetHandler():IsCanRemoveCounter(tp, 0x5b, 7, REASON_COST)
  end
...
function c89264428.tkctg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(Card.IsControlerCanBeChanged, tp, 0, LOCATION_MZONE, 1, nil) and c89264428.tkccon(e, tp, eg, ep, ev, re, r, rp)
  end

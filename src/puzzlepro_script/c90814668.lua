...
function c90814668.cfilter(c, e, tp)
  return c:IsType(TYPE_EFFECT) and Duel.GetMZoneCount(tp, c) > 0 and Duel.IsExistingMatchingCard(c90814668.spfilter, tp, LOCATION_GRAVE, 0, 1, c, e, tp, c:GetOriginalRace(), c:GetOriginalAttribute())
end

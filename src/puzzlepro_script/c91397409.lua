...
function c91397409.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c91397409.spfilter, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end
...
function c91397409.postg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c91397409.posfilter, tp, LOCATION_MZONE, 0, 1, nil)
  end
end

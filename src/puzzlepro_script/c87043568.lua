...
function c87043568.atkcon(e, tp, eg, ep, ev, re, r, rp)
  ...
  return a == e:GetHandler():GetEquipTarget() and ph == PHASE_DAMAGE and not Duel.IsDamageCalculated()
end
...
function c87043568.atkcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c87043568.cfilter, tp, LOCATION_HAND, 0, 1, nil)
  end

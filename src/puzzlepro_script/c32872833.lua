...
function c32872833.ntcon(e, c, minc)
  ...
  return minc == 0 and Duel.GetLocationCount(c:GetControler(), LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c32872833.filter, c:GetControler(), LOCATION_MZONE, 0, 1, nil)
end

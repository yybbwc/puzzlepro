...
function c65536818.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c65536818.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c65536818.lvcost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c65536818.costfilter, tp, LOCATION_DECK, 0, 1, nil, lv)
  end
...
function c65536818.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c65536818.spfilter, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end

...
function c14568951.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c14568951.cfilter1, tp, LOCATION_HAND, 0, 1, nil) and Duel.IsExistingMatchingCard(c14568951.cfilter2, tp, LOCATION_HAND, 0, 1, nil)
  end

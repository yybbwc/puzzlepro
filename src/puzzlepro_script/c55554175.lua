...
function c55554175.sctg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_PZONE) and chkc:IsControler(tp) and c55554175.scfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c55554175.scfilter, tp, LOCATION_PZONE, 0, 1, nil)
  end

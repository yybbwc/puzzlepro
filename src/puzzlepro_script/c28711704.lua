...
function c28711704.fselect(g, tp)
  ...
  return g:CheckWithSumGreater(Card.GetLevel, 8) and Duel.GetMZoneCount(tp, g) > 0 and Duel.CheckReleaseGroupEx(tp, aux.IsInGroup, #g, REASON_SPSUMMON, true, nil, g)
end
...
function c28711704.dircon(e)
  ...
  return Duel.IsExistingMatchingCard(c28711704.cfilter1, tp, LOCATION_ONFIELD, 0, 1, nil) and not Duel.IsExistingMatchingCard(c28711704.cfilter2, tp, 0, LOCATION_MZONE, 1, nil)
end

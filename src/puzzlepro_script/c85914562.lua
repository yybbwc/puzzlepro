...
function c85914562.spop2(e, tp, eg, ep, ev, re, r, rp)
  ...
  local ct = g:GetCount()
  if ct > 0 and Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and g:FilterCount(c85914562.spfilter, nil, e, tp) > 0 and Duel.SelectYesNo(tp, aux.Stringid(85914562, 2)) then

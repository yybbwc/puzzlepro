...
function c17201174.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return e:GetHandler():IsLevelAbove(2) and Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c17201174.filter, tp, LOCATION_HAND, 0, 1, nil, e, tp)
  end

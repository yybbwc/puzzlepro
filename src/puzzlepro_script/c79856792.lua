...
function c79856792.atcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c79856792.afilter, tp, LOCATION_MZONE, 0, 1, nil)
  end
...
function c79856792.tdcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c79856792.cfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

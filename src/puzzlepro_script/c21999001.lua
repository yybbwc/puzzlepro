...
function c21999001.sprcon(e, c)
  ...
  return Duel.GetFieldGroupCount(tp, LOCATION_MZONE, 0) == 0 and Duel.IsExistingMatchingCard(Card.IsSummonLocation, tp, 0, LOCATION_MZONE, 1, nil, LOCATION_EXTRA) and Duel.GetLocationCount(tp, LOCATION_MZONE) > 0
end

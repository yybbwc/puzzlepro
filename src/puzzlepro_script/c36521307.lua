...
function c36521307.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c36521307.costfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c36521307.checkop(e, tp, eg, ep, ev, re, r, rp)
  if Duel.GetFlagEffect(tp, 36521307) ~= 0 then
    return
  end
...
function c36521307.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c36521307.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

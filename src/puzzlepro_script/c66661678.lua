...
function c66661678.operation(e, tp, eg, ep, ev, re, r, rp)
  if Duel.GetLocationCount(1 - tp, LOCATION_MZONE, tp) <= 0 or not Duel.IsPlayerCanSpecialSummonMonster(tp, 66661679, 0, TYPES_TOKEN_MONSTER, 1000, 0, 1, RACE_AQUA, ATTRIBUTE_WATER, POS_FACEUP_ATTACK, 1 - tp) then
    return
  end

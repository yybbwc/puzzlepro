...
function c12670770.target1(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  c:RegisterEffect(e1)
  c:SetTurnCounter(0)
  if Duel.IsExistingMatchingCard(c12670770.filter1, tp, LOCATION_ONFIELD, LOCATION_ONFIELD, 1, nil) and Duel.IsExistingMatchingCard(c12670770.filter2, tp, LOCATION_DECK, 0, 1, nil) and Duel.SelectYesNo(tp, aux.Stringid(12670770, 0)) then
...
function c12670770.target2(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return e:GetHandler():GetFlagEffect(12670770) == 0 and Duel.IsExistingMatchingCard(c12670770.filter2, tp, LOCATION_DECK, 0, 1, nil)
  end
  Duel.SetOperationInfo(0, CATEGORY_REMOVE, nil, 1, tp, LOCATION_DECK)
...
function c12670770.operation(e, tp, eg, ep, ev, re, r, rp)
  if e:GetHandler():GetFlagEffect(12670770) == 0 or not e:GetHandler():IsRelateToEffect(e) then
    return
  end

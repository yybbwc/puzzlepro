...
function c89617515.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c89617515.tgfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c89617515.drtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsPlayerCanDraw(tp, 1) and Duel.IsExistingTarget(c89617515.tdfilter, tp, LOCATION_GRAVE, 0, 3, e:GetHandler())
  end

...
function c70645913.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c70645913.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c70645913.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c70645913.costfilter, tp, LOCATION_ONFIELD + LOCATION_HAND, 0, 1, nil, tp)
  end

...
function c75253697.destg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(c75253697.dfilter, tp, 0, LOCATION_MZONE, 1, nil, POS_FACEUP) and Duel.IsExistingTarget(c75253697.dfilter, tp, 0, LOCATION_SZONE, 1, nil, POS_FACEDOWN)
  end

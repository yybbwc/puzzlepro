...
function c84813516.descost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c84813516.costfilter, tp, LOCATION_HAND + LOCATION_ONFIELD, 0, 1, nil)
  end
...
function c84813516.destg(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c84813516.desfilter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, c, cg)
  end
...
function c84813516.thtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and chkc:IsAbleToHand()
  end
  if chk == 0 then

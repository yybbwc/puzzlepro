...
function c11074235.cfilter(c, tp)
  return bit.band(c:GetPreviousTypeOnField(), TYPE_SPELL + TYPE_TRAP) ~= 0 and c:IsPreviousControler(tp) and c:IsPreviousLocation(LOCATION_ONFIELD) and c:IsReason(REASON_EFFECT) and c:GetReasonPlayer() == 1 - tp
end

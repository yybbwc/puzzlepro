...
function c2834264.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c2834264.filter, tp, LOCATION_HAND + LOCATION_MZONE, 0, 1, nil)
  end
...
function c2834264.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c2834264.cfilter, tp, LOCATION_GRAVE, 0, 3, c)
  end

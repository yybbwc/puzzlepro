...
function c95218695.spcon(e, tp, eg, ep, ev, re, r, rp)
  return eg:IsExists(c95218695.cfilter, 1, nil, tp) and not Duel.IsExistingMatchingCard(Card.IsFaceup, tp, LOCATION_MZONE, 0, 1, nil)
end
...
function c95218695.postg(e, tp, eg, ep, ev, re, r, rp, chk)
  local c = e:GetHandler()
  if chk == 0 then
    return c:IsCanTurnSet() and c:GetFlagEffect(95218695) == 0
  end

...
function c38502358.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c38502358.spcfilter, tp, LOCATION_ONFIELD, 0, 1, c, cg, tp)
  end
...
function c38502358.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c38502358.spfilter, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end

...
function c20721759.condition(e, tp, eg, ep, ev, re, r, rp)
  ...
  return rp == 1 - tp and eg:GetCount() == 1 and ec:IsPreviousLocation(LOCATION_MZONE) and ec:IsPreviousControler(tp) and ec:IsReason(REASON_DESTROY) and ec:IsReason(REASON_EFFECT)
end

...
function c2563463.spcon(e, tp, eg, ep, ev, re, r, rp)
  ...
  return Duel.GetFieldGroupCount(tp, LOCATION_MZONE, 0) == 0 or Duel.IsExistingMatchingCard(c2563463.cfilter, tp, LOCATION_ONFIELD, 0, 1, nil)
end
...
function c2563463.negcon(e, tp, eg, ep, ev, re, r, rp)
  if not Duel.IsExistingMatchingCard(c2563463.cfilter, tp, LOCATION_ONFIELD, 0, 1, nil) then
    return false
  end

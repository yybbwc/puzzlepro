...
function c36092504.target(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return (g1:IsExists(Card.IsType, 1, nil, TYPE_FUSION) and g2:IsExists(Card.IsLocation, 1, nil, LOCATION_MZONE)) or (g1:IsExists(Card.IsType, 1, nil, TYPE_SYNCHRO) and g2:IsExists(c36092504.rmfilter1, 3, nil)) or (g1:IsExists(Card.IsType, 1, nil, TYPE_XYZ) and g2:IsExists(c36092504.rmfilter2, 1, nil)) or (g1:IsExists(Card.IsType, 1, nil, TYPE_LINK) and g2:IsExists(Card.IsLocation, 1, nil, LOCATION_GRAVE))
  end

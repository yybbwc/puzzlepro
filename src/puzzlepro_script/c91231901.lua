...
function c91231901.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(Card.IsCanAddCounter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil, 0x100e, 1) and Duel.IsExistingMatchingCard(c91231901.filter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c91231901.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c91231901.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

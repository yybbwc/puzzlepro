...
function c6850209.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return c6850209[tp] and Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c6850209.filter, tp, LOCATION_DECK + LOCATION_HAND, 0, 1, nil, e, tp)
  end

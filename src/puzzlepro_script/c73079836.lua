...
function c73079836.spop(e, tp, eg, ep, ev, re, r, rp)
  ...
  local ct = g:GetCount()
  if ct > 0 and Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and g:FilterCount(c73079836.spfilter, nil, e, tp) > 0 and Duel.SelectYesNo(tp, aux.Stringid(73079836, 2)) then

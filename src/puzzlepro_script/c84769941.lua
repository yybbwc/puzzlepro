...
function c84769941.spcon(e, c)
  ...
  return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c84769941.cfilter, tp, 0, LOCATION_MZONE, 1, nil)
end
...
function c84769941.eqtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_SZONE) > 0 and Duel.IsExistingMatchingCard(c84769941.eqfilter, tp, LOCATION_GRAVE + LOCATION_HAND, 0, 1, nil)
  end

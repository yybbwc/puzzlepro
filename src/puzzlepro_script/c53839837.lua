...
function c53839837.spr(e, tp, eg, ep, ev, re, r, rp)
  ...
  if bit.band(r, 0x41) ~= 0x41 or rp == tp or c:IsPreviousControler(1 - tp) then
    return
  end
...
function c53839837.tgop(e, tp, eg, ep, ev, re, r, rp)
  ...
  if e:GetLabel() == 0 then
    g = Duel.SelectMatchingCard(1 - tp, c53839837.tgfilter, 1 - tp, LOCATION_DECK, 0, 1, 1, nil, TYPE_MONSTER)
  elseif e:GetLabel() == 1 then
    g = Duel.SelectMatchingCard(1 - tp, c53839837.tgfilter, 1 - tp, LOCATION_DECK, 0, 1, 1, nil, TYPE_SPELL)
  else
    g = Duel.SelectMatchingCard(1 - tp, c53839837.tgfilter, 1 - tp, LOCATION_DECK, 0, 1, 1, nil, TYPE_TRAP)
  end

...
function c71442223.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return at:IsOnField() and at:IsCanBeEffectTarget(e) and Duel.IsExistingMatchingCard(c71442223.spfilter1, tp, LOCATION_HAND, 0, 1, nil, e, tp) and Duel.IsCanAddCounter(tp)
  end

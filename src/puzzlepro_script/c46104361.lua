...
function c46104361.spcon(e, c)
  ...
  return Duel.GetLocationCount(c:GetControler(), LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c46104361.filter, c:GetControler(), LOCATION_MZONE, 0, 1, nil, c:GetControler())
end

...
function c39049051.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c39049051.spfilter, tp, LOCATION_HAND, 0, 1, nil, e, tp)
  end
...
function c39049051.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c39049051.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

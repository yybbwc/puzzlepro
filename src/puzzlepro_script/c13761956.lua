...
function c13761956.attg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(tp) and c13761956.filter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c13761956.filter, tp, LOCATION_MZONE, 0, 1, nil)
  end

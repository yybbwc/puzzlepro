...
function c35371948.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsControler(1 - tp) and chkc:IsLocation(LOCATION_SZONE) and c35371948.cfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c35371948.cfilter, tp, 0, LOCATION_SZONE, 1, e:GetHandler())
  end
...
function c35371948.endcon(e, tp, eg, ep, ev, re, r, rp)
  ...
  if tc:GetFlagEffectLabel(35371948) == e:GetLabel() and c:GetFlagEffectLabel(35371948) == e:GetLabel() then
...
function c35371948.rstcon(e, tp, eg, ep, ev, re, r, rp)
  ...
  return tc:GetFlagEffectLabel(35371948) == e:GetLabel() and c:GetFlagEffectLabel(35371948) == e:GetLabel()
end
...
function c35371948.damcon2(e, tp, eg, ep, ev, re, r, rp)
  return ep ~= tp and Duel.GetLP(1 - tp) > 0 and bit.band(r, REASON_BATTLE) == 0 and re and re:IsActiveType(TYPE_MONSTER) and re:GetHandler():IsSetCard(0xfb)
end

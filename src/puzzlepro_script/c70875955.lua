...
function c70875955.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsPlayerCanSpecialSummonMonster(tp, 31533705, 0x101b, TYPES_TOKEN_MONSTER, 0, 0, 3, RACE_MACHINE, ATTRIBUTE_WIND)
  end
...
function c70875955.mtop(e, tp, eg, ep, ev, re, r, rp)
  if Duel.CheckReleaseGroupEx(tp, c70875955.rfilter, 1, REASON_MAINTENANCE, false, nil) and Duel.SelectYesNo(tp, aux.Stringid(70875955, 2)) then

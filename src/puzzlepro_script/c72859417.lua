...
function c72859417.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return g:CheckSubGroup(c72859417.fselect, 2, 2)
  end
...
function c72859417.activate(e, tp, eg, ep, ev, re, r, rp)
  ...
  local c1 = g:GetFirst()
  local c2 = g:GetNext()
  if not c1:IsRelateToEffect(e) or not c2:IsRelateToEffect(e) then
    return
  end
  if c1:IsImmuneToEffect(e) or c2:IsImmuneToEffect(e) then
    return
  end

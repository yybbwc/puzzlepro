...
function c5373478.atkcon(e)
  ...
  return (phase == PHASE_DAMAGE or phase == PHASE_DAMAGE_CAL) and Duel.GetAttacker() == e:GetHandler() and Duel.GetAttackTarget() ~= nil
end
...
function c5373478.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c5373478.costfilter, tp, LOCATION_HAND, 0, 1, nil)
  end

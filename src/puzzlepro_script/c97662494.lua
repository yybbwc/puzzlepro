...
function s.spfilter(c, e, tp)
  return c:IsSetCard(0x76) and c:IsCanBeSpecialSummoned(e, 0, tp, false, false, POS_FACEUP_DEFENSE) and c:IsCanBeEffectTarget(e)
end
...
function s.sptg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return ft > 1 and not Duel.IsPlayerAffectedByEffect(tp, 59822133) and g:CheckSubGroup(s.fselect, 2, 2)
  end

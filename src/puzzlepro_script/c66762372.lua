...
function c66762372.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c66762372.spfilter, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end
...
function c66762372.settg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c66762372.filter, tp, LOCATION_DECK, 0, 1, nil)
  end
end

...
function c80949182.atktg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c80949182.atkfilter, tp, 0, LOCATION_MZONE, 1, nil)
  end
end
...
function c80949182.damtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c80949182.damfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

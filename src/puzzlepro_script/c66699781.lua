...
function s.rmtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chkc then
    return chkc:IsOnField() and chkc:IsAbleToRemove() and chkc:IsControler(1 - tp)
  end
  if chk == 0 then
    return mgc > 0 and Duel.IsExistingTarget(Card.IsAbleToRemove, tp, 0, LOCATION_ONFIELD, 1, nil)
  end

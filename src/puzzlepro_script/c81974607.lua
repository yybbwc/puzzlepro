...
function c81974607.spcon(e, c)
  ...
  return Duel.GetLocationCount(c:GetControler(), LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c81974607.cfilter, c:GetControler(), LOCATION_MZONE, 0, 1, nil)
end
...
function c81974607.lvtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c81974607.lvfilter, tp, LOCATION_MZONE, 0, 1, e:GetHandler())
  end
end

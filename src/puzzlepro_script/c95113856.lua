...
function c95113856.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(Card.IsAbleToRemove, tp, 0, LOCATION_ONFIELD + LOCATION_HAND + LOCATION_GRAVE + LOCATION_DECK, 1, nil)
  end
  ...
  local op = aux.SelectFromOptions(tp, { b1, aux.Stringid(95113856, 1) }, { b2, aux.Stringid(95113856, 2) }, { b3, aux.Stringid(95113856, 3) }, { b4, aux.Stringid(95113856, 4) })
  e:SetLabel(op)

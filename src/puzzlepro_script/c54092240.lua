...
function c54092240.thcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetCustomActivityCount(54092240, tp, ACTIVITY_SPSUMMON) == 0 and Duel.IsExistingMatchingCard(c54092240.thcfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c54092240.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c54092240.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

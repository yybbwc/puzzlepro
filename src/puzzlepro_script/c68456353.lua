...
function c68456353.condition(e, tp, eg, ep, ev, re, r, rp)
  return re:IsHasType(EFFECT_TYPE_ACTIVATE) and rp == 1 - tp and Duel.IsChainNegatable(ev) and Duel.IsExistingMatchingCard(c68456353.cfilter, tp, LOCATION_MZONE, 0, 1, nil)
end

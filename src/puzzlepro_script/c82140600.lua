...
function c82140600.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return g:GetCount() > 4 and g:IsExists(Card.IsSetCard, 1, nil, 0xa7) and g:IsExists(Card.IsSetCard, 1, nil, 0xa8) and Duel.IsExistingMatchingCard(aux.TRUE, tp, LOCATION_ONFIELD, LOCATION_ONFIELD, 1, nil)
  end

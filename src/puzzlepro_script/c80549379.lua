...
function c80549379.repcon(e)
  ...
  return c:IsFaceup() and c:IsLocation(LOCATION_MZONE) and c:IsReason(REASON_DESTROY) and Duel.IsExistingMatchingCard(c80549379.filter, tp, LOCATION_MZONE, 0, 1, c)
end

...
function c30461781.target(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  local d = 1
  if Duel.GetFieldGroupCount(tp, LOCATION_DECK, 0) > 1 and Duel.IsExistingMatchingCard(c30461781.filter, tp, 0, LOCATION_MZONE, 1, nil) and Duel.SelectOption(tp, aux.Stringid(30461781, 0), aux.Stringid(30461781, 1)) == 1 then
    d = 2
  end

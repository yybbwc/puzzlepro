...
function c51852507.discon(e, tp, eg, ep, ev, re, r, rp)
  return ep ~= tp and re:IsActiveType(TYPE_TRAP) and re:IsHasType(EFFECT_TYPE_ACTIVATE) and Duel.IsChainNegatable(ev) and Duel.IsExistingMatchingCard(c51852507.cfilter, tp, LOCATION_MZONE, 0, 1, nil)
end

...
function c96693371.spcost1(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.CheckReleaseGroup(tp, c96693371.cfilter1, 1, nil, tp)
  end
...
function c96693371.sptg1(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsPlayerCanSpecialSummonMonster(tp, 96693371, 0x5008, TYPE_MONSTER + TYPE_EFFECT, 900, 1100, 3, RACE_WARRIOR, ATTRIBUTE_DARK)
  end

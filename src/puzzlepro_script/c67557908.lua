...
function c67557908.destg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c67557908.desfilter, tp, 0, LOCATION_MZONE, 1, nil)
  end
...
function c67557908.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCountFromEx(tp, tp, nil, TYPE_XYZ) > 0 and Duel.IsExistingMatchingCard(c67557908.spfilter, tp, LOCATION_EXTRA, 0, 1, nil, e, tp)
  end

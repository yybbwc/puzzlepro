...
function c27705190.cetarget(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c27705190.thfilter, rp, 0, LOCATION_MZONE, 1, nil)
  end
end
...
function c27705190.sptarget(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return c27705190.spfilter1(chkc, e, tp) and chkc:IsLocation(LOCATION_MZONE)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c27705190.spfilter1, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil, e, tp)
  end

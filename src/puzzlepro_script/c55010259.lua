...
function c55010259.sptg1(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c55010259.spfilter1, tp, LOCATION_HAND, 0, 1, nil, e, tp)
  end
...
function c55010259.sptg2(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c55010259.spfilter2, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end

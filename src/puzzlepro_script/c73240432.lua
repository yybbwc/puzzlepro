...
function c73240432.cfilter(c, tp)
  return c:IsControler(tp) and c:IsSetCard(0xad) and c:IsType(TYPE_FUSION) and c:IsSummonType(SUMMON_TYPE_FUSION)
end
...
function c73240432.damtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c73240432.damfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

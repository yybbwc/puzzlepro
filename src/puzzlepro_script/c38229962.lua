...
function c38229962.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.CheckReleaseGroup(tp, c38229962.spcostfilter, 1, nil, tp)
  end
...
function c38229962.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c38229962.spfilter, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end
...
function c38229962.atkcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.CheckReleaseGroup(tp, c38229962.costfilter, 1, e:GetHandler(), tp)
  end

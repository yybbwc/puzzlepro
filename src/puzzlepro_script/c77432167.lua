...
function c77432167.atkcost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.CheckLPCost(tp, lp - 100, true) and c:GetFlagEffect(77432167) == 0
  end
...
function c77432167.reccost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  local c = e:GetHandler()
  if chk == 0 then
    return Duel.CheckReleaseGroup(tp, c77432167.recfilter, 1, nil) and c:GetFlagEffect(77432167) == 0
  end

...
function c54199839.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c54199839.cfilter, tp, LOCATION_HAND, 0, 1, e:GetHandler())
  end
...
function c54199839.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c54199839.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

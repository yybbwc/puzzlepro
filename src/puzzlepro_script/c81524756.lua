...
function c81524756.dbtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsControler(tp) and chkc:IsLocation(LOCATION_MZONE) and c81524756.dbfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c81524756.dbfilter, tp, LOCATION_MZONE, 0, 1, nil)
  end

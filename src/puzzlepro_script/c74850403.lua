...
function c74850403.thcfilter(c, tp)
  return c:IsType(TYPE_PENDULUM) and c:IsPreviousSetCard(0x98) and c:IsPreviousControler(tp) and c:IsPreviousPosition(POS_FACEUP) and c:IsPreviousLocation(LOCATION_MZONE + LOCATION_PZONE)
end

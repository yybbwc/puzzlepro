...
function c61245403.thtg1(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c61245403.thfilter1, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c61245403.thtg2(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and c61245403.thfilter2(chkc, tp)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c61245403.thfilter2, tp, LOCATION_GRAVE, 0, 1, nil, tp)
  end

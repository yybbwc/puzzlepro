...
function c49105782.tdtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(1 - tp) and c49105782.tdfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c49105782.tdfilter, tp, 0, LOCATION_GRAVE, 1, nil)
  end

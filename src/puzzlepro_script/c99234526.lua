...
function c99234526.spcon(e, c)
  ...
  return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c99234526.spfilter, tp, LOCATION_GRAVE, 0, 1, nil)
end
...
function c99234526.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c99234526.filter, tp, LOCATION_DECK, 0, 1, nil)
  end

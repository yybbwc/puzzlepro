...
function c38695361.atktg1(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(tp) and c38695361.atkfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c38695361.atkfilter, tp, LOCATION_MZONE, 0, 1, nil)
  end
...
function c38695361.atkcon2(e)
  ...
  return Duel.GetCurrentPhase() == PHASE_DAMAGE_CAL and tc:GetFlagEffect(38695361) ~= 0 and tc:GetBattleTarget()
end

...
function c53776969.mfilter(c)
  return (c:IsLinkSetCard(0x17a) or c:IsLinkCode(56099748)) and c:IsLocation(LOCATION_MZONE) and c:GetSequence() < 5
end
...
function c53776969.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c53776969.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

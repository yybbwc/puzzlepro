...
function c76145933.spcon(e, c)
  ...
  return Duel.GetLocationCount(c:GetControler(), LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c76145933.filter, c:GetControler(), LOCATION_MZONE, 0, 1, nil)
end
...
function c76145933.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c76145933.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

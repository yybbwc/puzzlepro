...
namespace irr {
  ...
  namespace gui {
    ...
    */
    class CGUIFileSelectPanel : public IGUIElement {
    protected:
      io::IFileSystem *fileSystem;
      io::file_list *fileList;
      core::array<u32> filesIndex;
      ...
      stringw filterSuffix;
      io::path initialWorkingDir;
      io::path currentWorkingDir;
      //~ io::path lastWorkingDir;

      bool drawBack;

    public:
      CGUIFileSelectPanel(IGUIEnvironment *pEnvironment, IGUIElement *pParent, recti pRect, s32 id = -1);
    ...
    public:
      ...
      io::path getSelectedFileFullName();
      ...
      virtual bool endsWithIgnoreCase(const io::path &p, const io::path &suffix);
      ...
      virtual io::file_list *createFileList();
    ...
    public:
      ...
      static const c8 *staticTypeName() {
        return "fileSelectPanel";
      }

      //~ //! Sets the new caption of this element.
      virtual void setButtonText(const wchar_t *text_1, const wchar_t *text_2);
      ...
      //~ private:
      //~ virtual void addItem(stringw o1, s32 o2);
      virtual bool containsAllKeywords(const irr::core::stringw &str, const irr::core::stringw &filter);
      virtual void setWorkingDir(const wchar_t *o1, const const wchar_t *o2);
    };

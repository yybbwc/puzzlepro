...
function s.spop(e, tp, eg, ep, ev, re, r, rp)
  ...
  if Duel.SpecialSummonStep(tc, 0, tp, tp, true, false, POS_FACEUP) and not Duel.IsExistingMatchingCard(s.cfilter, tp, LOCATION_ONFIELD + LOCATION_GRAVE, 0, 1, nil) then

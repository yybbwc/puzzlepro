...
function c20788863.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c20788863.cfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c20788863.drtg1(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsPlayerCanDraw(tp, 1) and Duel.IsExistingMatchingCard(c20788863.filter, tp, LOCATION_DECK, 0, 1, nil)
  end

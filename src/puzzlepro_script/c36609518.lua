...
function c36609518.spcon(e, tp, eg, ep, ev, re, r, rp)
  return (Duel.GetCurrentPhase() == PHASE_MAIN1 or Duel.GetCurrentPhase() == PHASE_MAIN2) and not Duel.IsExistingMatchingCard(c36609518.cfilter, tp, LOCATION_MZONE, 0, 1, nil)
end
...
function c36609518.sptg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c36609518.spfilter, tp, LOCATION_GRAVE, 0, 1, nil, e, tp)
  end

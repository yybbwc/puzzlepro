...
function c58938528.atkcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c58938528.costfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c58938528.drcost(e, tp, eg, ep, ev, re, r, rp, chk)
  local c = e:GetHandler()
  if chk == 0 then
    return c:IsDiscardable() and Duel.IsExistingMatchingCard(c58938528.drfilter, tp, LOCATION_HAND, 0, 1, c)
  end

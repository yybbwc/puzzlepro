...
function c75347539.operation(e, tp, eg, ep, ev, re, r, rp)
  ...
  if g:GetCount() >= 2 and Duel.IsPlayerAffectedByEffect(tp, 59822133) then
    return
  end

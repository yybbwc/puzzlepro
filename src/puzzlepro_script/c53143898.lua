...
function c53143898.settg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c53143898.setfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
end
...
function c53143898.spop(e, tp, eg, ep, ev, re, r, rp)
  ...
  if tc1:IsRelateToEffect(e) and Duel.SendtoGrave(tc1, REASON_EFFECT) > 0 and tc1:IsLocation(LOCATION_GRAVE) and tc2:IsRelateToEffect(e) and aux.NecroValleyFilter()(tc2) then

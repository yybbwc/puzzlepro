...
function c18743376.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c18743376.spfilter, tp, LOCATION_HAND, 0, 1, nil, e, tp)
  end

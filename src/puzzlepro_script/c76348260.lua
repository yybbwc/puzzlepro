...
function c76348260.condition(e, tp, eg, ep, ev, re, r, rp)
  return tp == Duel.GetTurnPlayer() and not Duel.CheckPhaseActivity() and Duel.IsExistingMatchingCard(c76348260.cfilter, tp, LOCATION_MZONE, 0, 1, nil)
end
...
function c76348260.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c76348260.costfilter, tp, LOCATION_HAND, 0, 1, nil)
  end

...
function c24361622.thcfilter(c, tp)
  return c:IsType(TYPE_MONSTER) and Duel.IsExistingMatchingCard(c24361622.thfilter, tp, LOCATION_ONFIELD, LOCATION_ONFIELD, 1, c)
end
...
function c24361622.thcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.CheckReleaseGroupEx(tp, c24361622.thcfilter, 1, REASON_COST, true, nil, tp)
  end

...
function c96938986.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c96938986.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c96938986.tgtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c96938986.tgfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

...
function c56577312.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c56577312.ctfilter, tp, LOCATION_MZONE, 0, 1, nil) and Duel.IsExistingMatchingCard(c56577312.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c56577312.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c56577312.spfilter, tp, LOCATION_HAND, 0, 1, nil, e, tp)
  end

...
function c27796375.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c27796375.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c27796375.tgtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c27796375.tgfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

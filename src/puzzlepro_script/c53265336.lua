...
function c53265336.target(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  local b1 = ct >= 3 and Duel.IsExistingMatchingCard(Card.IsAbleToHand, tp, LOCATION_PZONE, 0, 1, nil) and Duel.IsExistingMatchingCard(c53265336.tpfilter, tp, LOCATION_EXTRA, 0, 1, nil) and Duel.GetFieldGroupCount(tp, LOCATION_PZONE, 0) > 0
  local b2 = ct >= 5 and Duel.IsExistingMatchingCard(c53265336.spfilter, tp, LOCATION_HAND, 0, 1, nil, e, tp) and Duel.GetLocationCount(tp, LOCATION_MZONE) > 0

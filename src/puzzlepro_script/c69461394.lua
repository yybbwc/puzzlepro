...
function c69461394.condition(e, tp, eg, ep, ev, re, r, rp)
  ...
  return eg:GetCount() == 1 and dg:IsLocation(LOCATION_GRAVE) and dg:IsReason(REASON_BATTLE) and dg:GetBattlePosition() == POS_FACEDOWN_DEFENSE and dg:GetReasonCard() == e:GetHandler()
end

...
function c41619242.atktg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(c41619242.atkfilter, tp, LOCATION_MZONE, 0, 1, nil) and Duel.IsExistingTarget(c41619242.atkfilter2, tp, 0, LOCATION_MZONE, 1, nil)
  end
...
function c41619242.disfilter(c, tp)
  return (c:IsSetCard(0x17a) or c:IsCode(56099748)) and c:IsLocation(LOCATION_MZONE) and c:IsFaceup() and c:IsControler(tp)
end

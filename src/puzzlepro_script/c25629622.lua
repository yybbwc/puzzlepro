...
function c25629622.thtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and c25629622.thfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c25629622.thfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end
...
function c25629622.settg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c25629622.setfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
end

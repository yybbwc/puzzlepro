...
function c79324191.setcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c79324191.costfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c79324191.settg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c79324191.setfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
end

...
function c35272499.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c35272499.cfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c35272499.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c35272499.spfilter, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end

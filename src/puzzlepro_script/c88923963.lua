...
function c88923963.tktg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsPlayerCanSpecialSummonMonster(tp, 88923964, 0x107a, TYPES_TOKEN_MONSTER, 1000, 1000, 4, RACE_WARRIOR, ATTRIBUTE_LIGHT)
  end

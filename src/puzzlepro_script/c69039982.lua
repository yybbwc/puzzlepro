...
function c69039982.eatg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(tp) and c69039982.eafilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c69039982.eafilter, tp, LOCATION_MZONE, 0, 1, nil)
  end

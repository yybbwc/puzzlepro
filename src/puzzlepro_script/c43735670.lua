...
function c43735670.thtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and c43735670.thfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c43735670.thfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

...
function c15464375.spcon(e, c)
  ...
  return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c15464375.spcfilter, tp, LOCATION_SZONE, 0, 1, nil)
end
...
function c15464375.tgcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c15464375.cfilter, tp, LOCATION_SZONE, 0, 2, nil)
  end
...
function c15464375.tgtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c15464375.tgfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

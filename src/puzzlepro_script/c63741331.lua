...
function c63741331.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.CheckReleaseGroup(tp, c63741331.cfilter, 1, nil)
  end
...
function c63741331.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(Card.IsCanAddCounter, tp, LOCATION_MZONE, LOCATION_MZONE, 2, nil, 0x1019, 3)
  end

...
function c17691568.limcon(e, tp, eg, ep, ev, re, r, rp)
  ...
  return rp == 1 - tp and c:IsReason(REASON_EFFECT) and c:IsPreviousControler(tp) and c:IsPreviousLocation(LOCATION_SZONE) and Duel.GetMatchingGroupCount(c17691568.cfilter, tp, LOCATION_MZONE, 0, nil) > 0
end

...
function c53871273.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c53871273.cfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end
...
function c53871273.tgtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c53871273.tgfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

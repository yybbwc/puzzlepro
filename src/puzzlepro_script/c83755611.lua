...
function c83755611.tdtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(Card.IsAbleToDeck, tp, LOCATION_ONFIELD, LOCATION_ONFIELD, 1, nil) and ct > 0
  end
...
function c83755611.destg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return ft > -1 and Duel.IsExistingTarget(c83755611.desfilter, tp, LOCATION_ONFIELD, 0, 1, nil, ft) and Duel.IsExistingTarget(c83755611.spfilter, tp, LOCATION_GRAVE, 0, 1, nil, e, tp)
  end

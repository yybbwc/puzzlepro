...
function c79890560.thtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsControler(tp) and chkc:IsLocation(LOCATION_REMOVED) and c79890560.thfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c79890560.thfilter, tp, LOCATION_REMOVED, 0, 1, nil)
  end

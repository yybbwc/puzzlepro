...
function s.condition1(e, tp, eg, ep, ev, re, r, rp)
  ...
  return Duel.GetTurnPlayer() == tp and (ph == PHASE_MAIN1 or ph == PHASE_MAIN2) and Duel.IsExistingMatchingCard(nil, tp, LOCATION_FZONE, LOCATION_FZONE, 1, nil)
end
...
function s.condition(e, tp, eg, ep, ev, re, r, rp)
  local ph = Duel.GetCurrentPhase()
  return Duel.IsExistingMatchingCard(nil, tp, LOCATION_FZONE, LOCATION_FZONE, 1, nil) or ph == PHASE_MAIN1 or ph == PHASE_MAIN2
end

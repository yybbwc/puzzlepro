...
function c54250060.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetLocationCount(tp, LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c54250060.spfilter, tp, LOCATION_DECK, 0, 1, nil, e, tp)
  end
...
function c54250060.thcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c54250060.cfilter, tp, LOCATION_GRAVE, 0, 4, nil)
  end
...
function c54250060.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c54250060.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

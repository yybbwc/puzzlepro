...
function c8559524.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c8559524.costfilter, tp, LOCATION_HAND, 0, 1, nil)
  end
...
function c8559524.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c8559524.filter, tp, LOCATION_DECK, 0, 1, nil)
  end

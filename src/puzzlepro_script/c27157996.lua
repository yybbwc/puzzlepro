...
function c27157996.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c27157996.filter, tp, LOCATION_MZONE, 0, 1, nil)
  end
...
function c27157996.thcost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c27157996.costfilter, tp, LOCATION_GRAVE, 0, 1, c)
  end

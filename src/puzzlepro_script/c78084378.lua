...
function c78084378.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.CheckReleaseGroup(tp, Card.IsRace, 1, nil, RACE_CYBERSE)
  end
...
function c78084378.thtg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  ...
  if chk == 0 then
    return Duel.IsExistingTarget(c78084378.filter1, tp, LOCATION_GRAVE, 0, 1, e:GetHandler()) and Duel.IsExistingTarget(c78084378.filter2, tp, LOCATION_GRAVE, 0, 1, nil)
  end

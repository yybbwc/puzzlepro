...
function c54257392.spcon(e, c)
  ...
  return Duel.GetLocationCount(c:GetControler(), LOCATION_MZONE) > 0 and Duel.IsExistingMatchingCard(c54257392.filter, c:GetControler(), LOCATION_MZONE, 0, 1, nil)
end
...
function c54257392.drcon(e, tp, eg, ep, ev, re, r, rp)
  return eg:IsExists(c54257392.cfilter, 1, nil, 1 - tp) and rp == 1 - tp and Duel.IsExistingMatchingCard(c54257392.drfilter, tp, LOCATION_MZONE, 0, 1, nil)
end

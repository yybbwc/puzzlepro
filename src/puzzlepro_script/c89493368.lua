...
function c89493368.spcost(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if chk == 0 then
    return c:IsAbleToGraveAsCost() and g:CheckSubGroupEach(c89493368.spchecks, c89493368.fgoal, tp, c)
  end
...
function c89493368.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c89493368.spfilter, tp, 0x13, 0, 1, nil, e, tp)
  end

...
function c41160595.setcon(e, tp, eg, ep, ev, re, r, rp)
  ...
  return bit.band(r, 0x41) == 0x41 and rp == 1 - tp and re:IsActiveType(TYPE_SPELL + TYPE_TRAP) and c:IsPreviousControler(tp) and c:IsPreviousLocation(LOCATION_ONFIELD) and c:IsPreviousPosition(POS_FACEDOWN)
end

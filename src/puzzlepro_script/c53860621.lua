...
function c53860621.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_MZONE) and c53860621.eqfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c53860621.eqfilter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, nil)
  end

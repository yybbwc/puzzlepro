...
function c27780618.tgtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c27780618.tgfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c27780618.thcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c27780618.thcfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end
...
function c27780618.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c27780618.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

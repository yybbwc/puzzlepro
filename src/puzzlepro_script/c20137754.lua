...
function c20137754.tgtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c20137754.tgfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
...
function c20137754.atkcon(e, tp, eg, ep, ev, re, r, rp)
  return e:GetHandler():GetFlagEffect(20137754) > 0 and aux.dscon(e, tp, eg, ep, ev, re, r, rp)
end

...
function s.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.GetMZoneCount(tp, e:GetHandler()) > 0 and Duel.IsExistingMatchingCard(s.spfilter, tp, LOCATION_GRAVE + LOCATION_HAND, 0, 1, nil, e, tp)
  end
...
function s.spop(e, tp, eg, ep, ev, re, r, rp)
  ...
  if Duel.GetMatchingGroupCount(aux.NecroValleyFilter(s.spfilter), tp, LOCATION_GRAVE + LOCATION_HAND, 0, nil, e, tp) == 0 then
    return
  end

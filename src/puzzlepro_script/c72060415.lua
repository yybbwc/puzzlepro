...
function c72060415.cost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c72060415.costfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end
...
function c72060415.target(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c72060415.filter, tp, LOCATION_DECK, 0, 1, nil)
  end

...
function c16759958.rectg(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
  if chkc then
    return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and c16759958.recfilter(chkc)
  end
  if chk == 0 then
    return Duel.IsExistingTarget(c16759958.recfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end

...
function c79383919.condition(e, tp, eg, ep, ev, re, r, rp)
  return re:IsHasType(EFFECT_TYPE_ACTIVATE) and Duel.IsChainNegatable(ev) and Duel.IsExistingMatchingCard(c79383919.cfilter, tp, LOCATION_MZONE, 0, 1, nil)
end
...
function c79383919.target(e, tp, eg, ep, ev, re, r, rp, chk)
  ...
  if e:IsHasType(EFFECT_TYPE_ACTIVATE) and Duel.IsExistingMatchingCard(c79383919.filter, tp, LOCATION_SZONE, 0, 1, nil) then

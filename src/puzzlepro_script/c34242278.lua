...
function c34242278.drcost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c34242278.cfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end
...
function c34242278.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c34242278.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end

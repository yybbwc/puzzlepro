...
function c50275295.discost(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c50275295.cfilter, tp, LOCATION_GRAVE, 0, 1, nil)
  end
...
function c50275295.thtg(e, tp, eg, ep, ev, re, r, rp, chk)
  if chk == 0 then
    return Duel.IsExistingMatchingCard(c50275295.thfilter, tp, LOCATION_DECK, 0, 1, nil)
  end
